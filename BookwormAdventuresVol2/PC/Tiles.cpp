...
Image* Sexy::IMAGE_TILE_MUTANT;
Image* Sexy::IMAGE_TILE_PLAGUED;
Image* Sexy::IMAGE_TILE_RAINBOW;
Image* Sexy::IMAGE_TILE_RAINBOW_GLOW;
Image* Sexy::IMAGE_TILE_RAINBOW_MO;
...
bool Sexy::ExtractInit_DefaultTilesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_TILE_CURSED = aMgr.GetImageThrow("IMAGE_TILE_CURSED");
		...
		IMAGE_TILE_MUTANT = aMgr.GetImageThrow("IMAGE_TILE_MUTANT");
		IMAGE_TILE_PLAGUED = aMgr.GetImageThrow("IMAGE_TILE_PLAGUED");
		IMAGE_TILE_RAINBOW = aMgr.GetImageThrow("IMAGE_TILE_RAINBOW");
		IMAGE_TILE_RAINBOW_GLOW = aMgr.GetImageThrow("IMAGE_TILE_RAINBOW_GLOW");
		IMAGE_TILE_RAINBOW_MO = aMgr.GetImageThrow("IMAGE_TILE_RAINBOW_MO");
		...
		IMAGE_TILE_WARPED = aMgr.GetImageThrow("IMAGE_TILE_WARPED");
	}
...
static void* gResources[] =
{
	...
	&IMAGE_TILE_RAINBOW,
	&IMAGE_TILE_RAINBOW_MO,
	&IMAGE_TILE_RAINBOW_GLOW,
	&IMAGE_TILE_MUTANT,
	NULL
};
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_TILE_WARPED_ID: return "IMAGE_TILE_WARPED";
		case IMAGE_TILE_CURSED_ID: return "IMAGE_TILE_CURSED";
		...
		case IMAGE_TILE_RAINBOW_ID: return "IMAGE_TILE_RAINBOW";
		case IMAGE_TILE_RAINBOW_MO_ID: return "IMAGE_TILE_RAINBOW_MO";
		case IMAGE_TILE_RAINBOW_GLOW_ID: return "IMAGE_TILE_RAINBOW_GLOW";
		case IMAGE_TILE_MUTANT_ID: return "IMAGE_TILE_MUTANT";
		default: return "";
	}
}
