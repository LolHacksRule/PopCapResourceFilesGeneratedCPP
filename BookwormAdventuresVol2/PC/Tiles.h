...
namespace Sexy
{
	...
	extern Image* IMAGE_TILE_CURSED;
	...
	extern Image* IMAGE_TILE_MUTANT;
	extern Image* IMAGE_TILE_PLAGUED;
	extern Image* IMAGE_TILE_RAINBOW;
	extern Image* IMAGE_TILE_RAINBOW_GLOW;
	extern Image* IMAGE_TILE_RAINBOW_MO;
	...
	extern Image* IMAGE_TILE_WARPED;
	...
	enum ResourceId
	{
		...
		IMAGE_TILE_WARPED_ID,
		IMAGE_TILE_CURSED_ID,
		...
		IMAGE_TILE_RAINBOW_ID,
		IMAGE_TILE_RAINBOW_MO_ID,
		IMAGE_TILE_RAINBOW_GLOW_ID,
		IMAGE_TILE_MUTANT_ID,
		RESOURCE_ID_MAX
	};
