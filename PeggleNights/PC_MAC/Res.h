...
namespace Sexy
{
	...
	extern Image* IMAGE_CHR_CHARACTER_ADV10;
	extern Image* IMAGE_CHR_CHARACTER_ADV11;
	...
	extern Image* IMAGE_CHR_CHARACTER_ADV5;
	extern Image* IMAGE_CHR_CHARACTER_ADV6;
	extern Image* IMAGE_CHR_CHARACTER_ADV7;
	extern Image* IMAGE_CHR_CHARACTER_ADV8;
	extern Image* IMAGE_CHR_CHARACTER_ADV9;
	extern Image* IMAGE_CHR_CHARACTER_NEW10;
	extern Image* IMAGE_CHR_CHARACTER_NEW11;
	...
	extern Image* IMAGE_CREDITS_BJORN2;
	extern Image* IMAGE_CREDITS_BJORN;
	extern Image* IMAGE_CREDITS_BUST;
	extern Image* IMAGE_CREDITS_CLOUD;
	extern Image* IMAGE_CREDITS_LIGHT;
	extern Image* IMAGE_CREDITS_LOGO;
	extern Image* IMAGE_CREDITS_PEDISTAL;
	extern Image* IMAGE_CREDITS_ROOM;
	extern Image* IMAGE_CREDITS_STARS;
	extern Image* IMAGE_CREDITS_TICKER1;
	extern Image* IMAGE_CREDITS_TICKER2;
	extern Image* IMAGE_CREDITS_TROPHY_ACE;
	extern Image* IMAGE_CREDITS_TROPHY_ADV;
	extern Image* IMAGE_CREDITS_TROPHY_ALLCLEAR;
	extern Image* IMAGE_CREDITS_TROPHY_CHAL;
	...
	extern int SOUND_BOARD_LEVEL_TITLE_WOOSH;
	extern int SOUND_BOARD_LEVEL_TITLE_WOOSH_OUT;
	...
	extern int SOUND_TROPHY_CURTAINS;
	...
	extern Image* IMAGE_MM_FIRELIGHT;
	...
	extern Image* IMAGE_TROPHY_PORTRAIT_10;
	extern Image* IMAGE_TROPHY_PORTRAIT_11;
	extern Image* IMAGE_TROPHY_PORTRAIT_1;
	extern Image* IMAGE_TROPHY_PORTRAIT_2;
	extern Image* IMAGE_TROPHY_PORTRAIT_3;
	extern Image* IMAGE_TROPHY_PORTRAIT_4;
	extern Image* IMAGE_TROPHY_PORTRAIT_5;
	extern Image* IMAGE_TROPHY_PORTRAIT_6;
	extern Image* IMAGE_TROPHY_PORTRAIT_7;
	extern Image* IMAGE_TROPHY_PORTRAIT_8;
	extern Image* IMAGE_TROPHY_PORTRAIT_9;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_10;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_11;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_1;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_2;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_3;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_4;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_5;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_6;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_7;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_8;
	extern Image* IMAGE_TROPHY_PORTRAIT_HIDDEN_9;
	...
	extern Image* IMAGE_TROPHY_SPOTLIGHT;
	extern Image* IMAGE_TROPHY_TABLE_BOTTOM;
	extern Image* IMAGE_TROPHY_TROPHYROOM_SCREEN;

	// Upsell Resources
	bool ExtractUpsellResources(ResourceManager *theMgr);
	extern Image* IMAGE_UPSELL_BALL;
	extern Image* IMAGE_UPSELL_BLURB1;
	extern Image* IMAGE_UPSELL_BLURB2;
	extern Image* IMAGE_UPSELL_BLURB3;
	extern Image* IMAGE_UPSELL_BLURB4;
	extern Image* IMAGE_UPSELL_BLURB5;
	extern Image* IMAGE_UPSELL_BLURB6;
	extern Image* IMAGE_UPSELL_BLURB7;
	extern Image* IMAGE_UPSELL_BLURB8;
	extern Image* IMAGE_UPSELL_BUY_NOW;
	extern Image* IMAGE_UPSELL_LEVEL1;
	extern Image* IMAGE_UPSELL_LEVEL2;
	extern Image* IMAGE_UPSELL_LEVEL3;
	extern Image* IMAGE_UPSELL_LEVEL4;
	extern Image* IMAGE_UPSELL_LEVEL5;
	extern Image* IMAGE_UPSELL_LEVEL6;
	extern Image* IMAGE_UPSELL_LOGO;
	extern Image* IMAGE_UPSELL_PEG;
	extern Image* IMAGE_UPSELL_SWOOSH;
	extern Image* IMAGE_UPSELL_TEXT;
	extern Image* IMAGE_UPSELL_ZEN;
	...
	enum ResourceId
	{
		...
		IMAGE_LOAD_BACK_ID,
		IMAGE_LOAD_BACKTUTE_ID,
		IMAGE_LOAD_BACKBRIGHT_ID,
		IMAGE_LOAD_HILL_ID,
		IMAGE_LOAD_HILLBRIGHT_ID,
		IMAGE_LOAD_HILL2_ID,
		...
		SOUND_BOARD_LEVEL_TITLE_WOOSH_ID,
		SOUND_BOARD_LEVEL_TITLE_WOOSH_OUT_ID,
		SOUND_SPEECH_BUBBLE_POPUP_ID,
		SOUND_TROPHY_WIN_INTRO_ID,
		SOUND_TROPHY_CURTAINS_ID,
		IMAGE_INT_BALL_ID,
		...
		IMAGE_TROPHY_TROPHYROOM_SCREEN_ID,
		IMAGE_TROPHY_PORTRAIT_1_ID,
		IMAGE_TROPHY_PORTRAIT_2_ID,
		IMAGE_TROPHY_PORTRAIT_3_ID,
		IMAGE_TROPHY_PORTRAIT_4_ID,
		IMAGE_TROPHY_PORTRAIT_5_ID,
		IMAGE_TROPHY_PORTRAIT_6_ID,
		IMAGE_TROPHY_PORTRAIT_7_ID,
		IMAGE_TROPHY_PORTRAIT_8_ID,
		IMAGE_TROPHY_PORTRAIT_9_ID,
		IMAGE_TROPHY_PORTRAIT_10_ID,
		IMAGE_TROPHY_PORTRAIT_11_ID,
		IMAGE_TROPHY_CURTAIN_ID,
		IMAGE_TROPHY_CURTAIN_L_ID,
		IMAGE_TROPHY_CURTAIN_R_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_1_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_2_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_3_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_4_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_5_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_6_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_7_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_8_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_9_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_10_ID,
		IMAGE_TROPHY_PORTRAIT_HIDDEN_11_ID,
		...
		IMAGE_TROPHY_TABLE_BOTTOM_ID,
		IMAGE_TROPHY_SPOTLIGHT_ID,
		...
		IMAGE_CHR_CHARACTER_ADV5_ID,
		IMAGE_CHR_CHARACTER_ADV6_ID,
		IMAGE_CHR_CHARACTER_ADV7_ID,
		IMAGE_CHR_CHARACTER_ADV8_ID,
		IMAGE_CHR_CHARACTER_ADV9_ID,
		IMAGE_CHR_CHARACTER_ADV10_ID,
		IMAGE_CHR_CHARACTER_ADV11_ID,
		...
		IMAGE_UPSELL_LEVEL1_ID,
		IMAGE_UPSELL_LEVEL2_ID,
		IMAGE_UPSELL_LEVEL3_ID,
		IMAGE_UPSELL_LEVEL4_ID,
		IMAGE_UPSELL_LEVEL5_ID,
		IMAGE_UPSELL_LEVEL6_ID,
		IMAGE_UPSELL_BUY_NOW_ID,
		IMAGE_UPSELL_BALL_ID,
		IMAGE_UPSELL_TEXT_ID,
		IMAGE_UPSELL_LOGO_ID,
		IMAGE_UPSELL_PEG_ID,
		IMAGE_UPSELL_SWOOSH_ID,
		IMAGE_UPSELL_BLURB1_ID,
		IMAGE_UPSELL_BLURB2_ID,
		IMAGE_UPSELL_BLURB3_ID,
		IMAGE_UPSELL_BLURB4_ID,
		IMAGE_UPSELL_BLURB5_ID,
		IMAGE_UPSELL_BLURB6_ID,
		IMAGE_UPSELL_BLURB7_ID,
		IMAGE_UPSELL_BLURB8_ID,
		IMAGE_UPSELL_ZEN_ID,
		IMAGE_CREDITS_BJORN_ID,
		IMAGE_CREDITS_BJORN2_ID,
		IMAGE_CREDITS_PEDISTAL_ID,
		IMAGE_CREDITS_ROOM_ID,
		IMAGE_CREDITS_LOGO_ID,
		IMAGE_CREDITS_CLOUD_ID,
		IMAGE_CREDITS_STARS_ID,
		IMAGE_CREDITS_LIGHT_ID,
		IMAGE_CREDITS_BUST_ID,
		IMAGE_CREDITS_TICKER1_ID,
		IMAGE_CREDITS_TICKER2_ID,
		IMAGE_CREDITS_TROPHY_ADV_ID,
		IMAGE_CREDITS_TROPHY_ACE_ID,
		IMAGE_CREDITS_TROPHY_CHAL_ID,
		IMAGE_CREDITS_TROPHY_ALLCLEAR_ID,
		RESOURCE_ID_MAX
	};
