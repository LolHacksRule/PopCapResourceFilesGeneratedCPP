...
Image* Sexy::IMAGE_ALMANAC_AREAQUARTER;
...
Image* Sexy::IMAGE_COB;
Image* Sexy::IMAGE_COBBIG;
Image* Sexy::IMAGE_COBBLESTONE;
Image* Sexy::IMAGE_COBCANNON_POPCORN;
Image* Sexy::IMAGE_COBCANNON_TARGET;
Image* Sexy::IMAGE_COFFEE;
...
Image* Sexy::IMAGE_LARGECLOUD;
Image* Sexy::IMAGE_LAWNMOWER;
Image* Sexy::IMAGE_LEAVES;
Image* Sexy::IMAGE_LEFTBUTTON;
Image* Sexy::IMAGE_LEX;
...
Image* Sexy::IMAGE_MISC40;
Image* Sexy::IMAGE_MISC80;
...
Image* Sexy::IMAGE_OPTIONSBUTTONNORMAL;
...
Image* Sexy::IMAGE_OPTIONS_SLIDERKNOB;
...
Image* Sexy::IMAGE_PHONOGRAPHGOLD;
...
Image* Sexy::IMAGE_PORTALBLUE;
Image* Sexy::IMAGE_PORTALORANGE;
...
Image* Sexy::IMAGE_REANIM_CALTROP_BODY2_STONE;
Image* Sexy::IMAGE_REANIM_CALTROP_BODY3_STONE;
Image* Sexy::IMAGE_REANIM_CALTROP_BODY_STONE;
...
Image* Sexy::IMAGE_SEEDDROPS;
Image* Sexy::IMAGE_SEEDPACKETEMPTY;
...
Image* Sexy::IMAGE_SEEDUPGRADEINTERFACE;
...
Image* Sexy::IMAGE_SPROUT;
Image* Sexy::IMAGE_SPROUTMARIGOLD;
...
bool Sexy::ExtractLoadingThreadResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ALMANAC_AREAQUARTER = aMgr.GetImageThrow("IMAGE_ALMANAC_AREAQUARTER");
		...
		IMAGE_BALLOON = aMgr.GetImageThrow("IMAGE_BALLOON");
		...
		IMAGE_CAUTION = aMgr.GetImageThrow("IMAGE_CAUTION");
		...
		IMAGE_COB = aMgr.GetImageThrow("IMAGE_COB");
		IMAGE_COBBIG = aMgr.GetImageThrow("IMAGE_COBBIG");
		IMAGE_COBBLESTONE = aMgr.GetImageThrow("IMAGE_COBBLESTONE");
		...
		IMAGE_COFFEE = aMgr.GetImageThrow("IMAGE_COFFEE");
		...
		IMAGE_CURSORS = aMgr.GetImageThrow("IMAGE_CURSORS");
		...
		IMAGE_FERTILIZERGOLD = aMgr.GetImageThrow("IMAGE_FERTILIZERGOLD");
		...
		IMAGE_FUMECLOUD = aMgr.GetImageThrow("IMAGE_FUMECLOUD");
		IMAGE_GOOGLYEYE = aMgr.GetImageThrow("IMAGE_GOOGLYEYE");
		IMAGE_GRASSPARTICLE = aMgr.GetImageThrow("IMAGE_GRASSPARTICLE");
		...
		IMAGE_LARGECLOUD = aMgr.GetImageThrow("IMAGE_LARGECLOUD");
		IMAGE_LAWNMOWER = aMgr.GetImageThrow("IMAGE_LAWNMOWER");
		IMAGE_LEAVES = aMgr.GetImageThrow("IMAGE_LEAVES");
		IMAGE_LEFTBUTTON = aMgr.GetImageThrow("IMAGE_LEFTBUTTON");
		IMAGE_LEX = aMgr.GetImageThrow("IMAGE_LEX");
		...
		IMAGE_MISC40 = aMgr.GetImageThrow("IMAGE_MISC40");
		IMAGE_MISC80 = aMgr.GetImageThrow("IMAGE_MISC80");
		...
		IMAGE_OPTIONSBUTTONNORMAL = aMgr.GetImageThrow("IMAGE_OPTIONSBUTTONNORMAL");
		...
		IMAGE_OPTIONS_SLIDERKNOB = aMgr.GetImageThrow("IMAGE_OPTIONS_SLIDERKNOB");
		...
		IMAGE_PHONOGRAPHGOLD = aMgr.GetImageThrow("IMAGE_PHONOGRAPHGOLD");
		...
		IMAGE_PORTALBLUE = aMgr.GetImageThrow("IMAGE_PORTALBLUE");
		IMAGE_PORTALORANGE = aMgr.GetImageThrow("IMAGE_PORTALORANGE");
		...
		IMAGE_REANIM_CALTROP_BODY2_STONE = aMgr.GetImageThrow("IMAGE_REANIM_CALTROP_BODY2_STONE");
		IMAGE_REANIM_CALTROP_BODY3_STONE = aMgr.GetImageThrow("IMAGE_REANIM_CALTROP_BODY3_STONE");
		IMAGE_REANIM_CALTROP_BODY_STONE = aMgr.GetImageThrow("IMAGE_REANIM_CALTROP_BODY_STONE");
		...
		IMAGE_SEEDDROPS = aMgr.GetImageThrow("IMAGE_SEEDDROPS");
		IMAGE_SEEDPACKETEMPTY = aMgr.GetImageThrow("IMAGE_SEEDPACKETEMPTY");
		...
		IMAGE_SEEDUPGRADEINTERFACE = aMgr.GetImageThrow("IMAGE_SEEDUPGRADEINTERFACE");
		...
		IMAGE_SLEEPING = aMgr.GetImageThrow("IMAGE_SLEEPING");
		...
		IMAGE_SPROUT = aMgr.GetImageThrow("IMAGE_SPROUT");
		IMAGE_SPROUTMARIGOLD = aMgr.GetImageThrow("IMAGE_SPROUTMARIGOLD");
		...
		IMAGE_SUN = aMgr.GetImageThrow("IMAGE_SUN");
		...
		IMAGE_WAITBAR = aMgr.GetImageThrow("IMAGE_WAITBAR");
		...
		SOUND_OPENINGMUSIC = aMgr.GetSoundThrow("SOUND_OPENINGMUSIC");
...
static void* gResources[] =
{
	...
	&IMAGE_FERTILIZER,
	&IMAGE_FERTILIZERGOLD,
	&IMAGE_WATERINGCAN,
	&IMAGE_WATERINGCANGOLD,
	&IMAGE_PHONOGRAPH,
	&IMAGE_PHONOGRAPHGOLD,
	...
	&IMAGE_REANIM_CALTROP_BODY_STONE,
	&IMAGE_REANIM_CALTROP_BODY2_STONE,
	&IMAGE_REANIM_CALTROP_BODY3_STONE,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_SEEDPACKETEMPTY_ID: return "IMAGE_SEEDPACKETEMPTY";
		case IMAGE_SEEDPACKETSILHOUETTE_ID: return "IMAGE_SEEDPACKETSILHOUETTE";
		case IMAGE_SEEDDROPS_ID: return "IMAGE_SEEDDROPS";
		...
		case IMAGE_SEEDUPGRADEINTERFACE_ID: return "IMAGE_SEEDUPGRADEINTERFACE";
		...
		case IMAGE_ALMANAC_AREAQUARTER_ID: return "IMAGE_ALMANAC_AREAQUARTER";
		...
		case IMAGE_OPTIONSBUTTONNORMAL_ID: return "IMAGE_OPTIONSBUTTONNORMAL";
		...
		case IMAGE_OPTIONS_SLIDERKNOB_ID: return "IMAGE_OPTIONS_SLIDERKNOB";
		...
		case IMAGE_PORTALORANGE_ID: return "IMAGE_PORTALORANGE";
		case IMAGE_PORTALBLUE_ID: return "IMAGE_PORTALBLUE";
		case IMAGE_WAITBAR_ID: return "IMAGE_WAITBAR";
		case IMAGE_MONEYFLASH_ID: return "IMAGE_MONEYFLASH";
		case IMAGE_SPEECHBUBBLE_ID: return "IMAGE_SPEECHBUBBLE";
		case IMAGE_SUN_ID: return "IMAGE_SUN";
		case IMAGE_COBBLESTONE_ID: return "IMAGE_COBBLESTONE";
		case IMAGE_SHOVEL_ID: return "IMAGE_SHOVEL";
		case IMAGE_CAUTION_ID: return "IMAGE_CAUTION";
		case IMAGE_LAWNMOWER_ID: return "IMAGE_LAWNMOWER";
		...
		case IMAGE_LEAVES_ID: return "IMAGE_LEAVES";
		...
		case IMAGE_FERTILIZERGOLD_ID: return "IMAGE_FERTILIZERGOLD";
		...
		case IMAGE_PHONOGRAPHGOLD_ID: return "IMAGE_PHONOGRAPHGOLD";
		...
		case IMAGE_MISC40_ID: return "IMAGE_MISC40";
		case IMAGE_MISC80_ID: return "IMAGE_MISC80";
		case IMAGE_CURSORS_ID: return "IMAGE_CURSORS";
		...
		case IMAGE_FUMECLOUD_ID: return "IMAGE_FUMECLOUD";
		case IMAGE_COB_ID: return "IMAGE_COB";
		case IMAGE_COBBIG_ID: return "IMAGE_COBBIG";
		case IMAGE_GRASSPARTICLE_ID: return "IMAGE_GRASSPARTICLE";
		...
		case IMAGE_LEX_ID: return "IMAGE_LEX";
		...
		case IMAGE_LARGECLOUD_ID: return "IMAGE_LARGECLOUD";
		...
		case IMAGE_SLEEPING_ID: return "IMAGE_SLEEPING";
		...
		case IMAGE_COFFEE_ID: return "IMAGE_COFFEE";
		case IMAGE_ICEBERG_ID: return "IMAGE_ICEBERG";
		case IMAGE_DUPLICATOR_ID: return "IMAGE_DUPLICATOR";
		case IMAGE_SPROUT_ID: return "IMAGE_SPROUT";
		case IMAGE_SPROUTMARIGOLD_ID: return "IMAGE_SPROUTMARIGOLD";
		...
		case IMAGE_BALLOON_ID: return "IMAGE_BALLOON";
		...
		case SOUND_OPENINGMUSIC_ID: return "SOUND_OPENINGMUSIC";
		...
		case IMAGE_REANIM_CALTROP_BODY_STONE_ID: return "IMAGE_REANIM_CALTROP_BODY_STONE";
		case IMAGE_REANIM_CALTROP_BODY2_STONE_ID: return "IMAGE_REANIM_CALTROP_BODY2_STONE";
		case IMAGE_REANIM_CALTROP_BODY3_STONE_ID: return "IMAGE_REANIM_CALTROP_BODY3_STONE";
