...
Image* Sexy::IMAGE_STORE_LAWNMOWER;
...
bool Sexy::ExtractDelayLoad_StoreResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_STORE_LAWNMOWER = aMgr.GetImageThrow("IMAGE_STORE_LAWNMOWER");
...
Image* Sexy::IMAGE_REANIM_ZOMBIE_FLAG2;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_REANIM_ZOMBIE_FLAG2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_FLAG2");
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_REANIM_ZOMBIE_FLAG2_ID: return "IMAGE_REANIM_ZOMBIE_FLAG2";
		...
		case IMAGE_STORE_LAWNMOWER_ID: return "IMAGE_STORE_LAWNMOWER";
