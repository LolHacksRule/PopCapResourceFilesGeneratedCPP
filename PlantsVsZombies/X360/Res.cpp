...
Image* Sexy::IMAGE_STORESEEDPACK_CATTAIL;
Image* Sexy::IMAGE_STORESEEDPACK_COBCANNON;
Image* Sexy::IMAGE_STORESEEDPACK_DOUBLESUNFLOWER;
Image* Sexy::IMAGE_STORESEEDPACK_FROZENWATERMELON;
Image* Sexy::IMAGE_STORESEEDPACK_GLOOMSHROOM;
Image* Sexy::IMAGE_STORESEEDPACK_GOLDMAGNET;
Image* Sexy::IMAGE_STORESEEDPACK_IMITATER;
Image* Sexy::IMAGE_STORESEEDPACK_REPEATER;
Image* Sexy::IMAGE_STORESEEDPACK_SPIKEROCK;
...
Image* Sexy::IMAGE_STORE_CAR_LICENSE0;
Image* Sexy::IMAGE_STORE_CAR_LICENSE1;
Image* Sexy::IMAGE_STORE_CAR_LICENSE10;
Image* Sexy::IMAGE_STORE_CAR_LICENSE11;
Image* Sexy::IMAGE_STORE_CAR_LICENSE2;
Image* Sexy::IMAGE_STORE_CAR_LICENSE3;
Image* Sexy::IMAGE_STORE_CAR_LICENSE4;
Image* Sexy::IMAGE_STORE_CAR_LICENSE5;
Image* Sexy::IMAGE_STORE_CAR_LICENSE6;
Image* Sexy::IMAGE_STORE_CAR_LICENSE7;
Image* Sexy::IMAGE_STORE_CAR_LICENSE8;
Image* Sexy::IMAGE_STORE_CAR_LICENSE9;
Image* Sexy::IMAGE_STORE_CAR_NIGHT;
Image* Sexy::IMAGE_STORE_COMING_SOON;
Image* Sexy::IMAGE_STORE_EXTRA_SLOT;
...
Image* Sexy::IMAGE_STORE_SOLD_OUT;
...
bool Sexy::ExtractDelayLoad_StoreResources(ResourceManager *theManager)
{
	...
	try
	{
		IMAGE_STORESEEDPACK_CATTAIL = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_CATTAIL");
		IMAGE_STORESEEDPACK_COBCANNON = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_COBCANNON");
		IMAGE_STORESEEDPACK_DOUBLESUNFLOWER = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_DOUBLESUNFLOWER");
		IMAGE_STORESEEDPACK_FROZENWATERMELON = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_FROZENWATERMELON");
		IMAGE_STORESEEDPACK_GLOOMSHROOM = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_GLOOMSHROOM");
		IMAGE_STORESEEDPACK_GOLDMAGNET = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_GOLDMAGNET");
		IMAGE_STORESEEDPACK_IMITATER = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_IMITATER");
		IMAGE_STORESEEDPACK_REPEATER = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_REPEATER");
		IMAGE_STORESEEDPACK_SPIKEROCK = aMgr.GetImageThrow("IMAGE_STORESEEDPACK_SPIKEROCK");
		...
		IMAGE_STORE_CAR_LICENSE0 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE0");
		IMAGE_STORE_CAR_LICENSE1 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE1");
		IMAGE_STORE_CAR_LICENSE10 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE10");
		IMAGE_STORE_CAR_LICENSE11 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE11");
		IMAGE_STORE_CAR_LICENSE2 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE2");
		IMAGE_STORE_CAR_LICENSE3 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE3");
		IMAGE_STORE_CAR_LICENSE4 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE4");
		IMAGE_STORE_CAR_LICENSE5 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE5");
		IMAGE_STORE_CAR_LICENSE6 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE6");
		IMAGE_STORE_CAR_LICENSE7 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE7");
		IMAGE_STORE_CAR_LICENSE8 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE8");
		IMAGE_STORE_CAR_LICENSE9 = aMgr.GetImageThrow("IMAGE_STORE_CAR_LICENSE9");
...
Image* Sexy::IMAGE_ESRB_RATING;
Image* Sexy::IMAGE_NO_GAMERPIC;
...
bool Sexy::ExtractInitResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ESRB_RATING = aMgr.GetImageThrow("IMAGE_ESRB_RATING");
		IMAGE_NO_GAMERPIC = aMgr.GetImageThrow("IMAGE_NO_GAMERPIC");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_TITLESCREEN_BALL;
Image* Sexy::IMAGE_TITLESCREEN_GLOW;
...
bool Sexy::ExtractLoaderBarResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_TITLESCREEN_BALL = aMgr.GetImageThrow("IMAGE_TITLESCREEN_BALL");
		IMAGE_TITLESCREEN_GLOW = aMgr.GetImageThrow("IMAGE_TITLESCREEN_GLOW");
...
Image* Sexy::IMAGE_BUTTER_ICON;
Image* Sexy::IMAGE_BUTTON_DOWN_LEFT;
Image* Sexy::IMAGE_BUTTON_DOWN_MIDDLE;
Image* Sexy::IMAGE_BUTTON_DOWN_RIGHT;
Image* Sexy::IMAGE_BUTTON_GLOW;
Image* Sexy::IMAGE_BUTTON_GLOW_LEFT;
Image* Sexy::IMAGE_BUTTON_GLOW_MIDDLE;
Image* Sexy::IMAGE_BUTTON_GLOW_RIGHT;
...
Image* Sexy::IMAGE_CHALLENGE_NAME_BACK;
...
Image* Sexy::IMAGE_COBCANNON_TARGET_1;
Image* Sexy::IMAGE_COBCANNON_TARGET_2;
Image* Sexy::IMAGE_COBCANNON_TARGET_3;
Image* Sexy::IMAGE_COBCANNON_TARGET_4;
...
Image* Sexy::IMAGE_CROW_BUBBLE;
Image* Sexy::IMAGE_CURSOR_ARROW_P1;
Image* Sexy::IMAGE_CURSOR_ARROW_P2;
Image* Sexy::IMAGE_CURSOR_FLOWER;
Image* Sexy::IMAGE_CURSOR_P1_TEXT;
Image* Sexy::IMAGE_CURSOR_P2_TEXT;
Image* Sexy::IMAGE_CURSOR_SKULL;
...
Image* Sexy::IMAGE_GAMEPAD_CURSOR_FRAME_BLUE;
Image* Sexy::IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW;
Image* Sexy::IMAGE_GAMEPAD_CURSOR_SHADOW;
Image* Sexy::IMAGE_GAMEPAD_IMAGE_P1;
Image* Sexy::IMAGE_GAMEPAD_IMAGE_P2;
Image* Sexy::IMAGE_HAMMER_ICON;
Image* Sexy::IMAGE_HEAVY_WEAPON_OVERLAY;
Image* Sexy::IMAGE_HELP_BUTTONS;
Image* Sexy::IMAGE_HELP_BUTTONS_SMALL;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_BUTTER;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_CONTROLLER;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_COOP_MENU;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_COOP_SUN;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_PLANTS;
Image* Sexy::IMAGE_HELP_MENU_IMAGE_SHADOW;
...
Image* Sexy::IMAGE_HELP_MENU_IMAGE_ZOMBIES;
Image* Sexy::IMAGE_HELP_MENU_PAPER_1;
Image* Sexy::IMAGE_HELP_MENU_PAPER_2;
Image* Sexy::IMAGE_HELP_SUN_SHOT;
Image* Sexy::IMAGE_HOUSE_HILL;
Image* Sexy::IMAGE_HOUSE_SIDEWALK;
Image* Sexy::IMAGE_HOUSE_SKY;
...
Image* Sexy::IMAGE_LEADERBOARD_FILL;
Image* Sexy::IMAGE_LEADERBOARD_HEADER_LARGE;
Image* Sexy::IMAGE_LEADERBOARD_HEADER_SMALL;
Image* Sexy::IMAGE_LEADERBOARD_HOLE;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_BJORN;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_CHINA;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_GEMS;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_PIPE;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_ROCKS;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_TIKI;
Image* Sexy::IMAGE_LEADERBOARD_HOLE_WORM;
Image* Sexy::IMAGE_LEADERBOARD_SELECTOR;
Image* Sexy::IMAGE_LOCK;
Image* Sexy::IMAGE_LOCK_OPEN;
Image* Sexy::IMAGE_MAILBOX_TABLE;
Image* Sexy::IMAGE_MAILBOX_TABLE_LEAVESSHADOWS;
...
Image* Sexy::IMAGE_MP_PLANT_SIDE;
Image* Sexy::IMAGE_MP_PLANT_SIDE_PLANTS;
Image* Sexy::IMAGE_MP_PLANT_SIDE_SELECTED;
Image* Sexy::IMAGE_MP_PLANT_TROPHY;
Image* Sexy::IMAGE_MP_PLANT_TROPHY_HI_RES;
Image* Sexy::IMAGE_MP_TARGET;
Image* Sexy::IMAGE_MP_TARGETS_UI;
Image* Sexy::IMAGE_MP_TARGETS_X;
Image* Sexy::IMAGE_MP_TOMBSTONE;
Image* Sexy::IMAGE_MP_TROPHY_BASE;
Image* Sexy::IMAGE_MP_TROPHY_BASE_HI_RES;
Image* Sexy::IMAGE_MP_ZOMBIE_SIDE;
Image* Sexy::IMAGE_MP_ZOMBIE_SIDE_SELECTED;
Image* Sexy::IMAGE_MP_ZOMBIE_SIDE_ZOMBIES;
Image* Sexy::IMAGE_MP_ZOMBIE_TROPHY;
Image* Sexy::IMAGE_MP_ZOMBIE_TROPHY_HI_RES;
...
Image* Sexy::IMAGE_PERISCOPE;
Image* Sexy::IMAGE_PERISCOPE_RETICULE;
...
Image* Sexy::IMAGE_PLANT_LAYER_1_1;
Image* Sexy::IMAGE_PLANT_LAYER_1_2;
Image* Sexy::IMAGE_PLANT_LAYER_2_1;
Image* Sexy::IMAGE_PLANT_LAYER_2_2;
Image* Sexy::IMAGE_PLANT_LAYER_3_1;
Image* Sexy::IMAGE_PLANT_LAYER_3_2;
...
Image* Sexy::IMAGE_REANIM_POINT;
Image* Sexy::IMAGE_REANIM_POT_TOP_DARK;
Image* Sexy::IMAGE_REANIM_PUMPKIN_DAMAGE1;
Image* Sexy::IMAGE_REANIM_PUMPKIN_DAMAGE3;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD1;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD2;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD4;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD5;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD6;
Image* Sexy::IMAGE_REANIM_SELECTORSCREEN_CLOUD7;
...
Image* Sexy::IMAGE_SEEDCHOOSER_BACKGROUND2;
...
Image* Sexy::IMAGE_SEED_SELECTOR_BLUE;
Image* Sexy::IMAGE_SHOVEL;
Image* Sexy::IMAGE_SHOVELBANK;
Image* Sexy::IMAGE_SHOVELMETER_EMTY;
Image* Sexy::IMAGE_SHOVELMETER_FULL;
...
Image* Sexy::IMAGE_SQUARE_TEXTURE;
Image* Sexy::IMAGE_SQUARE_TEXTURE_ZOMBIE;
Image* Sexy::IMAGE_STAR_PARTICLES;
Image* Sexy::IMAGE_STAR_SPLATS;
Image* Sexy::IMAGE_STORE_AQUARIUMGARDENICON;
Image* Sexy::IMAGE_STORE_BLUEPRINT_BLING;
Image* Sexy::IMAGE_STORE_BLUEPRINT_CHANGE;
Image* Sexy::IMAGE_STORE_BLUEPRINT_CLOWN;
Image* Sexy::IMAGE_STORE_BLUEPRINT_FUTURE;
Image* Sexy::IMAGE_STORE_BLUEPRINT_SCARY;
Image* Sexy::IMAGE_STORE_BLUEPRINT_TRAILER;
...
Image* Sexy::IMAGE_STORE_ZENGARDENICON;
...
Image* Sexy::IMAGE_TRANSITION_HOLE;
Image* Sexy::IMAGE_TRASHCAN_PLANTS;
Image* Sexy::IMAGE_TRASHCAN_ZOMBIES;
...
Image* Sexy::IMAGE_ZOMBIE_HEAD;
Image* Sexy::IMAGE_ZOMBIE_LAYER_1_1;
Image* Sexy::IMAGE_ZOMBIE_LAYER_1_2;
Image* Sexy::IMAGE_ZOMBIE_LAYER_1_3;
Image* Sexy::IMAGE_ZOMBIE_LAYER_2_1;
Image* Sexy::IMAGE_ZOMBIE_LAYER_2_2;
Image* Sexy::IMAGE_ZOMBIE_LAYER_2_3;
Image* Sexy::IMAGE_ZOMBIE_LAYER_3_1;
Image* Sexy::IMAGE_ZOMBIE_LAYER_3_2;
Image* Sexy::IMAGE_ZOMBIE_LAYER_3_3;
Image* Sexy::IMAGE_ZOMBIE_LAYER_TEST;
Image* Sexy::IMAGE_ZOMBIE_NOTE_SMALL;
Image* Sexy::IMAGE_ZOMBIE_SEAWEED;
Image* Sexy::IMAGE_ZOMBIE_SEEDBANK;
Image* Sexy::IMAGE_ZOMBIE_SEEDPACKET;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_BUTTER_ICON = aMgr.GetImageThrow("IMAGE_BUTTER_ICON");
		...
		IMAGE_BUTTON_GLOW = aMgr.GetImageThrow("IMAGE_BUTTON_GLOW");
		IMAGE_BUTTON_GLOW_LEFT = aMgr.GetImageThrow("IMAGE_BUTTON_GLOW_LEFT");
		IMAGE_BUTTON_GLOW_MIDDLE = aMgr.GetImageThrow("IMAGE_BUTTON_GLOW_MIDDLE");
		IMAGE_BUTTON_GLOW_RIGHT = aMgr.GetImageThrow("IMAGE_BUTTON_GLOW_RIGHT");
		...
		IMAGE_CHALLENGE_NAME_BACK = aMgr.GetImageThrow("IMAGE_CHALLENGE_NAME_BACK");
		...
		IMAGE_COBCANNON_TARGET_1 = aMgr.GetImageThrow("IMAGE_COBCANNON_TARGET_1");
		IMAGE_COBCANNON_TARGET_2 = aMgr.GetImageThrow("IMAGE_COBCANNON_TARGET_2");
		IMAGE_COBCANNON_TARGET_3 = aMgr.GetImageThrow("IMAGE_COBCANNON_TARGET_3");
		IMAGE_COBCANNON_TARGET_4 = aMgr.GetImageThrow("IMAGE_COBCANNON_TARGET_4");
		...
		IMAGE_CROW_BUBBLE = aMgr.GetImageThrow("IMAGE_CROW_BUBBLE");
		IMAGE_CURSOR_ARROW_P1 = aMgr.GetImageThrow("IMAGE_CURSOR_ARROW_P1");
		IMAGE_CURSOR_ARROW_P2 = aMgr.GetImageThrow("IMAGE_CURSOR_ARROW_P2");
		IMAGE_CURSOR_FLOWER = aMgr.GetImageThrow("IMAGE_CURSOR_FLOWER");
		IMAGE_CURSOR_P1_TEXT = aMgr.GetImageThrow("IMAGE_CURSOR_P1_TEXT");
		IMAGE_CURSOR_P2_TEXT = aMgr.GetImageThrow("IMAGE_CURSOR_P2_TEXT");
		IMAGE_CURSOR_SKULL = aMgr.GetImageThrow("IMAGE_CURSOR_SKULL");
		...
		IMAGE_GAMEPAD_CURSOR_FRAME_BLUE = aMgr.GetImageThrow("IMAGE_GAMEPAD_CURSOR_FRAME_BLUE");
		IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW = aMgr.GetImageThrow("IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW");
		IMAGE_GAMEPAD_CURSOR_SHADOW = aMgr.GetImageThrow("IMAGE_GAMEPAD_CURSOR_SHADOW");
		IMAGE_GAMEPAD_IMAGE_P1 = aMgr.GetImageThrow("IMAGE_GAMEPAD_IMAGE_P1");
		IMAGE_GAMEPAD_IMAGE_P2 = aMgr.GetImageThrow("IMAGE_GAMEPAD_IMAGE_P2");
		IMAGE_HAMMER_ICON = aMgr.GetImageThrow("IMAGE_HAMMER_ICON");
		IMAGE_HEAVY_WEAPON_OVERLAY = aMgr.GetImageThrow("IMAGE_HEAVY_WEAPON_OVERLAY");
		IMAGE_HELP_BUTTONS = aMgr.GetImageThrow("IMAGE_HELP_BUTTONS");
		IMAGE_HELP_BUTTONS_SMALL = aMgr.GetImageThrow("IMAGE_HELP_BUTTONS_SMALL");
		IMAGE_HELP_MENU_IMAGE_BUTTER = aMgr.GetImageThrow("IMAGE_HELP_MENU_IMAGE_BUTTER");
		IMAGE_HELP_MENU_IMAGE_CONTROLLER = aMgr.GetImageThrow("IMAGE_HELP_MENU_IMAGE_CONTROLLER");
		...
		IMAGE_HELP_MENU_IMAGE_PLANTS = aMgr.GetImageThrow("IMAGE_HELP_MENU_IMAGE_PLANTS");
		IMAGE_HELP_MENU_IMAGE_SHADOW = aMgr.GetImageThrow("IMAGE_HELP_MENU_IMAGE_SHADOW");
		...
		IMAGE_HELP_MENU_IMAGE_ZOMBIES = aMgr.GetImageThrow("IMAGE_HELP_MENU_IMAGE_ZOMBIES");
		IMAGE_HELP_MENU_PAPER_1 = aMgr.GetImageThrow("IMAGE_HELP_MENU_PAPER_1");
		IMAGE_HELP_MENU_PAPER_2 = aMgr.GetImageThrow("IMAGE_HELP_MENU_PAPER_2");
		IMAGE_HELP_SUN_SHOT = aMgr.GetImageThrow("IMAGE_HELP_SUN_SHOT");
		IMAGE_HOUSE_HILL = aMgr.GetImageThrow("IMAGE_HOUSE_HILL");
		IMAGE_HOUSE_SIDEWALK = aMgr.GetImageThrow("IMAGE_HOUSE_SIDEWALK");
		IMAGE_HOUSE_SKY = aMgr.GetImageThrow("IMAGE_HOUSE_SKY");
		...
		IMAGE_LEADERBOARD_FILL = aMgr.GetImageThrow("IMAGE_LEADERBOARD_FILL");
		IMAGE_LEADERBOARD_HEADER_LARGE = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HEADER_LARGE");
		IMAGE_LEADERBOARD_HEADER_SMALL = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HEADER_SMALL");
		IMAGE_LEADERBOARD_HOLE = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE");
		IMAGE_LEADERBOARD_HOLE_BJORN = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_BJORN");
		IMAGE_LEADERBOARD_HOLE_CHINA = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_CHINA");
		IMAGE_LEADERBOARD_HOLE_GEMS = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_GEMS");
		IMAGE_LEADERBOARD_HOLE_PIPE = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_PIPE");
		IMAGE_LEADERBOARD_HOLE_ROCKS = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_ROCKS");
		IMAGE_LEADERBOARD_HOLE_TIKI = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_TIKI");
		IMAGE_LEADERBOARD_HOLE_WORM = aMgr.GetImageThrow("IMAGE_LEADERBOARD_HOLE_WORM");
		IMAGE_LEADERBOARD_SELECTOR = aMgr.GetImageThrow("IMAGE_LEADERBOARD_SELECTOR");
		IMAGE_LOCK = aMgr.GetImageThrow("IMAGE_LOCK");
		IMAGE_LOCK_OPEN = aMgr.GetImageThrow("IMAGE_LOCK_OPEN");
		IMAGE_MAILBOX_TABLE = aMgr.GetImageThrow("IMAGE_MAILBOX_TABLE");
		IMAGE_MAILBOX_TABLE_LEAVESSHADOWS = aMgr.GetImageThrow("IMAGE_MAILBOX_TABLE_LEAVESSHADOWS");
		...
		IMAGE_MP_PLANT_SIDE = aMgr.GetImageThrow("IMAGE_MP_PLANT_SIDE");
		IMAGE_MP_PLANT_SIDE_PLANTS = aMgr.GetImageThrow("IMAGE_MP_PLANT_SIDE_PLANTS");
		IMAGE_MP_PLANT_SIDE_SELECTED = aMgr.GetImageThrow("IMAGE_MP_PLANT_SIDE_SELECTED");
		IMAGE_MP_PLANT_TROPHY = aMgr.GetImageThrow("IMAGE_MP_PLANT_TROPHY");
		IMAGE_MP_PLANT_TROPHY_HI_RES = aMgr.GetImageThrow("IMAGE_MP_PLANT_TROPHY_HI_RES");
		IMAGE_MP_TARGET = aMgr.GetImageThrow("IMAGE_MP_TARGET");
		IMAGE_MP_TARGETS_UI = aMgr.GetImageThrow("IMAGE_MP_TARGETS_UI");
		IMAGE_MP_TARGETS_X = aMgr.GetImageThrow("IMAGE_MP_TARGETS_X");
		IMAGE_MP_TOMBSTONE = aMgr.GetImageThrow("IMAGE_MP_TOMBSTONE");
		IMAGE_MP_TROPHY_BASE = aMgr.GetImageThrow("IMAGE_MP_TROPHY_BASE");
		IMAGE_MP_TROPHY_BASE_HI_RES = aMgr.GetImageThrow("IMAGE_MP_TROPHY_BASE_HI_RES");
		IMAGE_MP_ZOMBIE_SIDE = aMgr.GetImageThrow("IMAGE_MP_ZOMBIE_SIDE");
		IMAGE_MP_ZOMBIE_SIDE_SELECTED = aMgr.GetImageThrow("IMAGE_MP_ZOMBIE_SIDE_SELECTED");
		IMAGE_MP_ZOMBIE_SIDE_ZOMBIES = aMgr.GetImageThrow("IMAGE_MP_ZOMBIE_SIDE_ZOMBIES");
		IMAGE_MP_ZOMBIE_TROPHY = aMgr.GetImageThrow("IMAGE_MP_ZOMBIE_TROPHY");
		IMAGE_MP_ZOMBIE_TROPHY_HI_RES = aMgr.GetImageThrow("IMAGE_MP_ZOMBIE_TROPHY_HI_RES");
		...
		IMAGE_PERISCOPE = aMgr.GetImageThrow("IMAGE_PERISCOPE");
		IMAGE_PERISCOPE_RETICULE = aMgr.GetImageThrow("IMAGE_PERISCOPE_RETICULE");
		...
		IMAGE_PLANT_LAYER_1_1 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_1_1");
		IMAGE_PLANT_LAYER_1_2 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_1_2");
		IMAGE_PLANT_LAYER_2_1 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_2_1");
		IMAGE_PLANT_LAYER_2_2 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_2_2");
		IMAGE_PLANT_LAYER_3_1 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_3_1");
		IMAGE_PLANT_LAYER_3_2 = aMgr.GetImageThrow("IMAGE_PLANT_LAYER_3_2");
		...
		IMAGE_REANIM_POINT = aMgr.GetImageThrow("IMAGE_REANIM_POINT");
		...
		IMAGE_REANIM_SELECTORSCREEN_CLOUD1 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD1");
		IMAGE_REANIM_SELECTORSCREEN_CLOUD2 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD2");
		IMAGE_REANIM_SELECTORSCREEN_CLOUD4 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD4");
		IMAGE_REANIM_SELECTORSCREEN_CLOUD5 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD5");
		IMAGE_REANIM_SELECTORSCREEN_CLOUD6 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD6");
		IMAGE_REANIM_SELECTORSCREEN_CLOUD7 = aMgr.GetImageThrow("IMAGE_REANIM_SELECTORSCREEN_CLOUD7");
		...
		IMAGE_SEEDCHOOSER_BACKGROUND2 = aMgr.GetImageThrow("IMAGE_SEEDCHOOSER_BACKGROUND2");
		...
		IMAGE_SEED_SELECTOR_BLUE = aMgr.GetImageThrow("IMAGE_SEED_SELECTOR_BLUE");
		IMAGE_SHOVEL = aMgr.GetImageThrow("IMAGE_SHOVEL");
		IMAGE_SHOVELBANK = aMgr.GetImageThrow("IMAGE_SHOVELBANK");
		IMAGE_SHOVELMETER_EMTY = aMgr.GetImageThrow("IMAGE_SHOVELMETER_EMTY");
		IMAGE_SHOVELMETER_FULL = aMgr.GetImageThrow("IMAGE_SHOVELMETER_FULL");
		...
		IMAGE_SQUARE_TEXTURE = aMgr.GetImageThrow("IMAGE_SQUARE_TEXTURE");
		IMAGE_SQUARE_TEXTURE_ZOMBIE = aMgr.GetImageThrow("IMAGE_SQUARE_TEXTURE_ZOMBIE");
		...
		IMAGE_STORE_BLUEPRINT_BLING = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_BLING");
		IMAGE_STORE_BLUEPRINT_CHANGE = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_CHANGE");
		IMAGE_STORE_BLUEPRINT_CLOWN = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_CLOWN");
		IMAGE_STORE_BLUEPRINT_FUTURE = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_FUTURE");
		IMAGE_STORE_BLUEPRINT_SCARY = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_SCARY");
		IMAGE_STORE_BLUEPRINT_TRAILER = aMgr.GetImageThrow("IMAGE_STORE_BLUEPRINT_TRAILER");
		...
		IMAGE_STORE_ZENGARDENICON = aMgr.GetImageThrow("IMAGE_STORE_ZENGARDENICON");
		...
		IMAGE_TRANSITION_HOLE = aMgr.GetImageThrow("IMAGE_TRANSITION_HOLE");
		IMAGE_TRASHCAN_PLANTS = aMgr.GetImageThrow("IMAGE_TRASHCAN_PLANTS");
		IMAGE_TRASHCAN_ZOMBIES = aMgr.GetImageThrow("IMAGE_TRASHCAN_ZOMBIES");
		...
		IMAGE_ZOMBIE_HEAD = aMgr.GetImageThrow("IMAGE_ZOMBIE_HEAD");
		IMAGE_ZOMBIE_LAYER_1_1 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_1_1");
		IMAGE_ZOMBIE_LAYER_1_2 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_1_2");
		IMAGE_ZOMBIE_LAYER_1_3 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_1_3");
		IMAGE_ZOMBIE_LAYER_2_1 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_2_1");
		IMAGE_ZOMBIE_LAYER_2_2 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_2_2");
		IMAGE_ZOMBIE_LAYER_2_3 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_2_3");
		IMAGE_ZOMBIE_LAYER_3_1 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_3_1");
		IMAGE_ZOMBIE_LAYER_3_2 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_3_2");
		IMAGE_ZOMBIE_LAYER_3_3 = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_3_3");
		IMAGE_ZOMBIE_LAYER_TEST = aMgr.GetImageThrow("IMAGE_ZOMBIE_LAYER_TEST");
		...
		IMAGE_ZOMBIE_SEEDBANK = aMgr.GetImageThrow("IMAGE_ZOMBIE_SEEDBANK");
		IMAGE_ZOMBIE_SEEDPACKET = aMgr.GetImageThrow("IMAGE_ZOMBIE_SEEDPACKET");
...
int Sexy::SOUND_CROW_CAW1;
int Sexy::SOUND_CROW_CAW2;
int Sexy::SOUND_CROW_CAW3;
int Sexy::SOUND_CROW_FLAP1;
int Sexy::SOUND_CROW_FLAP2;
int Sexy::SOUND_CROW_FLAP3;
...
int Sexy::SOUND_MENU_C_ST;
int Sexy::SOUND_MENU_L_ST;
int Sexy::SOUND_MENU_R_ST;
int Sexy::SOUND_MINDCONTROLLED;
int Sexy::SOUND_MINIGAMES;
int Sexy::SOUND_MONEYFALLS;
int Sexy::SOUND_MP_TIMER;
...
int Sexy::SOUND_THUNDER_1;
int Sexy::SOUND_THUNDER_1R;
int Sexy::SOUND_THUNDER_2;
int Sexy::SOUND_THUNDER_2R;
int Sexy::SOUND_THUNDER_3;
int Sexy::SOUND_THUNDER_3R;
int Sexy::SOUND_VASE_BREAKING;
int Sexy::SOUND_VS;
int Sexy::SOUND_VS_HEADPOP;
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager *theManager)
{
	...
	try
	{
		SOUND_ALMANAC = aMgr.GetSoundThrow("SOUND_ALMANAC");
		...
		SOUND_BIGTHUD = aMgr.GetSoundThrow("SOUND_BIGTHUD");
		...
		SOUND_CROW_CAW1 = aMgr.GetSoundThrow("SOUND_CROW_CAW1");
		SOUND_CROW_CAW2 = aMgr.GetSoundThrow("SOUND_CROW_CAW2");
		SOUND_CROW_CAW3 = aMgr.GetSoundThrow("SOUND_CROW_CAW3");
		SOUND_CROW_FLAP1 = aMgr.GetSoundThrow("SOUND_CROW_FLAP1");
		SOUND_CROW_FLAP2 = aMgr.GetSoundThrow("SOUND_CROW_FLAP2");
		SOUND_CROW_FLAP3 = aMgr.GetSoundThrow("SOUND_CROW_FLAP3");
		...
		SOUND_MAIL = aMgr.GetSoundThrow("SOUND_MAIL");
		SOUND_MELONIMPACT = aMgr.GetSoundThrow("SOUND_MELONIMPACT");
		SOUND_MELONIMPACT2 = aMgr.GetSoundThrow("SOUND_MELONIMPACT2");
		SOUND_MENU_C_ST = aMgr.GetSoundThrow("SOUND_MENU_C_ST");
		SOUND_MENU_L_ST = aMgr.GetSoundThrow("SOUND_MENU_L_ST");
		SOUND_MENU_R_ST = aMgr.GetSoundThrow("SOUND_MENU_R_ST");
		SOUND_MINDCONTROLLED = aMgr.GetSoundThrow("SOUND_MINDCONTROLLED");
		SOUND_MINIGAMES = aMgr.GetSoundThrow("SOUND_MINIGAMES");
		SOUND_MONEYFALLS = aMgr.GetSoundThrow("SOUND_MONEYFALLS");
		SOUND_MP_TIMER = aMgr.GetSoundThrow("SOUND_MP_TIMER");
		...
		SOUND_PUZZLE = aMgr.GetSoundThrow("SOUND_PUZZLE");
		...
		SOUND_SHOP = aMgr.GetSoundThrow("SOUND_SHOP");
		...
		SOUND_SURVIVAL = aMgr.GetSoundThrow("SOUND_SURVIVAL");
		...
		SOUND_THUNDER_1 = aMgr.GetSoundThrow("SOUND_THUNDER_1");
		SOUND_THUNDER_1R = aMgr.GetSoundThrow("SOUND_THUNDER_1R");
		SOUND_THUNDER_2 = aMgr.GetSoundThrow("SOUND_THUNDER_2");
		SOUND_THUNDER_2R = aMgr.GetSoundThrow("SOUND_THUNDER_2R");
		SOUND_THUNDER_3 = aMgr.GetSoundThrow("SOUND_THUNDER_3");
		SOUND_THUNDER_3R = aMgr.GetSoundThrow("SOUND_THUNDER_3R");
		SOUND_VASE_BREAKING = aMgr.GetSoundThrow("SOUND_VASE_BREAKING");
		SOUND_VS = aMgr.GetSoundThrow("SOUND_VS");
		...
		SOUND_ZEN = aMgr.GetSoundThrow("SOUND_ZEN");
...
static void* gResources[] =
{
	...
	&IMAGE_ESRB_RATING,
	&IMAGE_TITLESCREEN,
	&IMAGE_TITLESCREEN_BALL,
	&IMAGE_TITLESCREEN_GLOW,
	&IMAGE_LOADBAR_DIRT,
	&IMAGE_LOADBAR_GRASS,
	&IMAGE_PVZ_LOGO,
	...
	&IMAGE_CHOCOLATE,
	&IMAGE_ZOMBIE_SEEDPACKET,
	&IMAGE_ZOMBIE_SEEDBANK,
	&IMAGE_MAILBOX_TABLE,
	&IMAGE_MAILBOX_TABLE_LEAVESSHADOWS,
	&IMAGE_COOP_SUN_HIGHLIGHT_1,
	&IMAGE_COOP_SUN_HIGHLIGHT_2,
	&IMAGE_DLG_SELECTORFRAME,
	&IMAGE_CHALLENGE_NAME_BACK,
	&IMAGE_HELP_MENU_PAPER_1,
	&IMAGE_HELP_MENU_PAPER_2,
	&IMAGE_HELP_MENU_IMAGE_SHADOW,
	&IMAGE_HELP_SUN_SHOT,
	&IMAGE_HELP_MENU_IMAGE_PLANTS,
	&IMAGE_HELP_MENU_IMAGE_ZOMBIES,
	&IMAGE_HELP_MENU_IMAGE_CONTROLLER,
	&IMAGE_HELP_MENU_IMAGE_VS_CONTROLLERS,
	&IMAGE_HELP_MENU_IMAGE_VS_BRAINS,
	&IMAGE_HELP_MENU_IMAGE_VS_TARGETS,
	&IMAGE_HELP_MENU_IMAGE_COOP_MENU,
	&IMAGE_HELP_MENU_IMAGE_COOP_SUN,
	&IMAGE_HELP_MENU_IMAGE_BUTTER,
	&IMAGE_STORE_BLUEPRINT_BLING,
	&IMAGE_STORE_BLUEPRINT_SCARY,
	&IMAGE_STORE_BLUEPRINT_FUTURE,
	&IMAGE_STORE_BLUEPRINT_TRAILER,
	&IMAGE_STORE_BLUEPRINT_CLOWN,
	&IMAGE_STORE_BLUEPRINT_CHANGE,
	...
	&IMAGE_COBCANNON_TARGET_1,
	&IMAGE_COBCANNON_TARGET_2,
	&IMAGE_COBCANNON_TARGET_3,
	&IMAGE_COBCANNON_TARGET_4,
	...
	&IMAGE_PERISCOPE,
	&IMAGE_SQUARE_TEXTURE,
	&IMAGE_SQUARE_TEXTURE_ZOMBIE,
	&IMAGE_CURSOR_FLOWER,
	&IMAGE_CURSOR_SKULL,
	&IMAGE_CURSOR_ARROW_P1,
	&IMAGE_CURSOR_ARROW_P2,
	&IMAGE_CURSOR_P1_TEXT,
	&IMAGE_CURSOR_P2_TEXT,
	&IMAGE_GAMEPAD_CURSOR_SHADOW,
	&IMAGE_GAMEPAD_CURSOR_FRAME,
	&IMAGE_GAMEPAD_CURSOR_FRAME_BLUE,
	&IMAGE_GAMEPAD_CURSOR_FRAME_SHADOW,
	&IMAGE_GAMEPAD_CURSOR_ARROWS,
	&IMAGE_GAMEPAD_CURSOR_ARROWS_SHADOW,
	&IMAGE_MP_TARGET,
	&IMAGE_PERISCOPE_RETICULE,
	&IMAGE_HEAVY_WEAPON_OVERLAY,
	&IMAGE_GAMEPAD_IMAGE_P1,
	&IMAGE_GAMEPAD_IMAGE_P2,
	&IMAGE_MP_PLANT_TROPHY,
	&IMAGE_MP_PLANT_TROPHY_HI_RES,
	&IMAGE_MP_ZOMBIE_TROPHY,
	&IMAGE_MP_ZOMBIE_TROPHY_HI_RES,
	&IMAGE_MP_TROPHY_BASE,
	&IMAGE_MP_TROPHY_BASE_HI_RES,
	&IMAGE_MP_PLANT_SIDE,
	&IMAGE_MP_PLANT_SIDE_SELECTED,
	&IMAGE_MP_PLANT_SIDE_PLANTS,
	&IMAGE_MP_ZOMBIE_SIDE,
	&IMAGE_MP_ZOMBIE_SIDE_SELECTED,
	&IMAGE_MP_ZOMBIE_SIDE_ZOMBIES,
	&IMAGE_VS_INFO_BOX_PLANTS,
	&IMAGE_VS_INFO_BOX_PLANTS_OVERLAY,
	&IMAGE_VS_INFO_BOX_ZOMBIES,
	&IMAGE_VS_INFO_BOX_ZOMBIES_OVERLAY,
	&IMAGE_BUTTER_ICON,
	&IMAGE_HAMMER_ICON,
	&IMAGE_VS_STONE_DIRT,
	...
	&IMAGE_STORE_ZENGARDENICON,
	&IMAGE_SHOVELMETER_EMTY,
	&IMAGE_SHOVELMETER_FULL,
	&IMAGE_PROJECTILEPEA,
	...
	&IMAGE_CONVEYORBELT,
	&IMAGE_CONVEYORBELT_BACKDROP_COOP,
	&IMAGE_CONVEYORBELT_COOP,
	&IMAGE_SHOVELBANK,
	&IMAGE_SUNBANK,
	&IMAGE_COINBANK,
	&IMAGE_POOL,
	...
	&IMAGE_HOUSE_SKY,
	&IMAGE_HOUSE_HILL,
	&IMAGE_HOUSE_SIDEWALK,
	&IMAGE_TRASHCAN_ZOMBIES,
	&IMAGE_TRASHCAN_PLANTS,
	&IMAGE_ZOMBIE_LAYER_TEST,
	&IMAGE_ZOMBIE_LAYER_1_1,
	&IMAGE_ZOMBIE_LAYER_1_2,
	&IMAGE_ZOMBIE_LAYER_1_3,
	&IMAGE_ZOMBIE_LAYER_2_1,
	&IMAGE_ZOMBIE_LAYER_2_2,
	&IMAGE_ZOMBIE_LAYER_2_3,
	&IMAGE_ZOMBIE_LAYER_3_1,
	&IMAGE_ZOMBIE_LAYER_3_2,
	&IMAGE_ZOMBIE_LAYER_3_3,
	&IMAGE_PLANT_LAYER_1_1,
	&IMAGE_PLANT_LAYER_1_2,
	&IMAGE_PLANT_LAYER_2_1,
	&IMAGE_PLANT_LAYER_2_2,
	&IMAGE_PLANT_LAYER_3_1,
	&IMAGE_PLANT_LAYER_3_2,
	...
	&IMAGE_LOCK_OPEN,
	&IMAGE_ZOMBIE_HEAD,
	&IMAGE_LEADERBOARD_HOLE,
	&IMAGE_LEADERBOARD_HOLE_PIPE,
	&IMAGE_LEADERBOARD_HOLE_WORM,
	&IMAGE_LEADERBOARD_HOLE_GEMS,
	&IMAGE_LEADERBOARD_HOLE_CHINA,
	&IMAGE_LEADERBOARD_HOLE_ROCKS,
	&IMAGE_LEADERBOARD_HOLE_TIKI,
	&IMAGE_LEADERBOARD_HOLE_BJORN,
	&IMAGE_LEADERBOARD_HEADER_SMALL,
	&IMAGE_LEADERBOARD_HEADER_LARGE,
	&IMAGE_LEADERBOARD_SELECTOR,
	&IMAGE_LEADERBOARD_FILL,
	&SOUND_AWOOGA,
	&SOUND_BLEEP,
	&SOUND_BUZZER,
	&SOUND_CHOMP,
	...
	&IMAGE_STORE_CAR_LICENSE0,
	&IMAGE_STORE_CAR_LICENSE1,
	&IMAGE_STORE_CAR_LICENSE2,
	&IMAGE_STORE_CAR_LICENSE3,
	&IMAGE_STORE_CAR_LICENSE4,
	&IMAGE_STORE_CAR_LICENSE5,
	&IMAGE_STORE_CAR_LICENSE6,
	&IMAGE_STORE_CAR_LICENSE7,
	&IMAGE_STORE_CAR_LICENSE8,
	&IMAGE_STORE_CAR_LICENSE9,
	&IMAGE_STORE_CAR_LICENSE10,
	&IMAGE_STORE_CAR_LICENSE11,
	...
	&IMAGE_STORESEEDPACK_CATTAIL,
	&IMAGE_STORESEEDPACK_COBCANNON,
	&IMAGE_STORESEEDPACK_DOUBLESUNFLOWER,
	&IMAGE_STORESEEDPACK_FROZENWATERMELON,
	&IMAGE_STORESEEDPACK_GLOOMSHROOM,
	&IMAGE_STORESEEDPACK_GOLDMAGNET,
	&IMAGE_STORESEEDPACK_IMITATER,
	&IMAGE_STORESEEDPACK_REPEATER,
	&IMAGE_STORESEEDPACK_SPIKEROCK,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		case IMAGE_NO_GAMERPIC_ID: return "IMAGE_NO_GAMERPIC";
		case IMAGE_BLANK_ID: return "IMAGE_BLANK";
		case IMAGE_ESRB_RATING_ID: return "IMAGE_ESRB_RATING";
		case IMAGE_TITLESCREEN_ID: return "IMAGE_TITLESCREEN";
		case IMAGE_TITLESCREEN_BALL_ID: return "IMAGE_TITLESCREEN_BALL";
		case IMAGE_TITLESCREEN_GLOW_ID: return "IMAGE_TITLESCREEN_GLOW";
		...
		case IMAGE_BUTTON_GLOW_LEFT_ID: return "IMAGE_BUTTON_GLOW_LEFT";
		case IMAGE_BUTTON_GLOW_MIDDLE_ID: return "IMAGE_BUTTON_GLOW_MIDDLE";
		case IMAGE_BUTTON_GLOW_RIGHT_ID: return "IMAGE_BUTTON_GLOW_RIGHT";
		...
		case IMAGE_BUTTON_GLOW_ID: return "IMAGE_BUTTON_GLOW";
		case IMAGE_TRANSITION_HOLE_ID: return "IMAGE_TRANSITION_HOLE";
		case IMAGE_CROW_BUBBLE_ID: return "IMAGE_CROW_BUBBLE";
		...
		case IMAGE_SEEDCHOOSER_BACKGROUND2_ID: return "IMAGE_SEEDCHOOSER_BACKGROUND2";
		...
		case IMAGE_ZOMBIE_SEEDPACKET_ID: return "IMAGE_ZOMBIE_SEEDPACKET";
		case IMAGE_ZOMBIE_SEEDBANK_ID: return "IMAGE_ZOMBIE_SEEDBANK";
		case IMAGE_MAILBOX_TABLE_ID: return "IMAGE_MAILBOX_TABLE";
		case IMAGE_MAILBOX_TABLE_LEAVESSHADOWS_ID: return "IMAGE_MAILBOX_TABLE_LEAVESSHADOWS";
		case IMAGE_COOP_SUN_HIGHLIGHT_1_ID: return "IMAGE_COOP_SUN_HIGHLIGHT_1";
		case IMAGE_COOP_SUN_HIGHLIGHT_2_ID: return "IMAGE_COOP_SUN_HIGHLIGHT_2";
		case IMAGE_DLG_SELECTORFRAME_ID: return "IMAGE_DLG_SELECTORFRAME";
		case IMAGE_CHALLENGE_NAME_BACK_ID: return "IMAGE_CHALLENGE_NAME_BACK";
		case IMAGE_HELP_MENU_PAPER_1_ID: return "IMAGE_HELP_MENU_PAPER_1";
		case IMAGE_HELP_MENU_PAPER_2_ID: return "IMAGE_HELP_MENU_PAPER_2";
		case IMAGE_HELP_MENU_IMAGE_SHADOW_ID: return "IMAGE_HELP_MENU_IMAGE_SHADOW";
		case IMAGE_HELP_SUN_SHOT_ID: return "IMAGE_HELP_SUN_SHOT";
		case IMAGE_HELP_MENU_IMAGE_PLANTS_ID: return "IMAGE_HELP_MENU_IMAGE_PLANTS";
		case IMAGE_HELP_MENU_IMAGE_ZOMBIES_ID: return "IMAGE_HELP_MENU_IMAGE_ZOMBIES";
		case IMAGE_HELP_MENU_IMAGE_CONTROLLER_ID: return "IMAGE_HELP_MENU_IMAGE_CONTROLLER";
		case IMAGE_HELP_MENU_IMAGE_VS_CONTROLLERS_ID: return "IMAGE_HELP_MENU_IMAGE_VS_CONTROLLERS";
		case IMAGE_HELP_MENU_IMAGE_VS_BRAINS_ID: return "IMAGE_HELP_MENU_IMAGE_VS_BRAINS";
		case IMAGE_HELP_MENU_IMAGE_VS_TARGETS_ID: return "IMAGE_HELP_MENU_IMAGE_VS_TARGETS";
		case IMAGE_HELP_MENU_IMAGE_COOP_MENU_ID: return "IMAGE_HELP_MENU_IMAGE_COOP_MENU";
		case IMAGE_HELP_MENU_IMAGE_COOP_SUN_ID: return "IMAGE_HELP_MENU_IMAGE_COOP_SUN";
		case IMAGE_HELP_MENU_IMAGE_BUTTER_ID: return "IMAGE_HELP_MENU_IMAGE_BUTTER";
		case IMAGE_STORE_BLUEPRINT_BLING_ID: return "IMAGE_STORE_BLUEPRINT_BLING";
		case IMAGE_STORE_BLUEPRINT_SCARY_ID: return "IMAGE_STORE_BLUEPRINT_SCARY";
		case IMAGE_STORE_BLUEPRINT_FUTURE_ID: return "IMAGE_STORE_BLUEPRINT_FUTURE";
		case IMAGE_STORE_BLUEPRINT_TRAILER_ID: return "IMAGE_STORE_BLUEPRINT_TRAILER";
		case IMAGE_STORE_BLUEPRINT_CLOWN_ID: return "IMAGE_STORE_BLUEPRINT_CLOWN";
		case IMAGE_STORE_BLUEPRINT_CHANGE_ID: return "IMAGE_STORE_BLUEPRINT_CHANGE";
		...
		case IMAGE_HELP_BUTTONS_ID: return "IMAGE_HELP_BUTTONS";
		case IMAGE_HELP_BUTTONS_SMALL_ID: return "IMAGE_HELP_BUTTONS_SMALL";
		...
		case IMAGE_MP_TOMBSTONE_ID: return "IMAGE_MP_TOMBSTONE";
		case IMAGE_MP_TARGETS_UI_ID: return "IMAGE_MP_TARGETS_UI";
		case IMAGE_MP_TARGETS_X_ID: return "IMAGE_MP_TARGETS_X";
		...
		case IMAGE_COBCANNON_TARGET_1_ID: return "IMAGE_COBCANNON_TARGET_1";
		case IMAGE_COBCANNON_TARGET_2_ID: return "IMAGE_COBCANNON_TARGET_2";
		case IMAGE_COBCANNON_TARGET_3_ID: return "IMAGE_COBCANNON_TARGET_3";
		case IMAGE_COBCANNON_TARGET_4_ID: return "IMAGE_COBCANNON_TARGET_4";
		...
		case IMAGE_SEED_SELECTOR_BLUE_ID: return "IMAGE_SEED_SELECTOR_BLUE";
		case IMAGE_PERISCOPE_ID: return "IMAGE_PERISCOPE";
		case IMAGE_SQUARE_TEXTURE_ID: return "IMAGE_SQUARE_TEXTURE";
		case IMAGE_SQUARE_TEXTURE_ZOMBIE_ID: return "IMAGE_SQUARE_TEXTURE_ZOMBIE";
		case IMAGE_CURSOR_FLOWER_ID: return "IMAGE_CURSOR_FLOWER";
		case IMAGE_CURSOR_SKULL_ID: return "IMAGE_CURSOR_SKULL";
		case IMAGE_CURSOR_ARROW_P1_ID: return "IMAGE_CURSOR_ARROW_P1";
		case IMAGE_CURSOR_ARROW_P2_ID: return "IMAGE_CURSOR_ARROW_P2";
		case IMAGE_CURSOR_P1_TEXT_ID: return "IMAGE_CURSOR_P1_TEXT";
		case IMAGE_CURSOR_P2_TEXT_ID: return "IMAGE_CURSOR_P2_TEXT";
		case IMAGE_GAMEPAD_CURSOR_SHADOW_ID: return "IMAGE_GAMEPAD_CURSOR_SHADOW";
		case IMAGE_GAMEPAD_CURSOR_FRAME_ID: return "IMAGE_GAMEPAD_CURSOR_FRAME";
		case IMAGE_GAMEPAD_CURSOR_FRAME_BLUE_ID: return "IMAGE_GAMEPAD_CURSOR_FRAME_BLUE";
		...
		case IMAGE_MP_TARGET_ID: return "IMAGE_MP_TARGET";
		case IMAGE_PERISCOPE_RETICULE_ID: return "IMAGE_PERISCOPE_RETICULE";
		case IMAGE_HEAVY_WEAPON_OVERLAY_ID: return "IMAGE_HEAVY_WEAPON_OVERLAY";
		case IMAGE_GAMEPAD_IMAGE_P1_ID: return "IMAGE_GAMEPAD_IMAGE_P1";
		case IMAGE_GAMEPAD_IMAGE_P2_ID: return "IMAGE_GAMEPAD_IMAGE_P2";
		case IMAGE_MP_PLANT_TROPHY_ID: return "IMAGE_MP_PLANT_TROPHY";
		case IMAGE_MP_PLANT_TROPHY_HI_RES_ID: return "IMAGE_MP_PLANT_TROPHY_HI_RES";
		case IMAGE_MP_ZOMBIE_TROPHY_ID: return "IMAGE_MP_ZOMBIE_TROPHY";
		case IMAGE_MP_ZOMBIE_TROPHY_HI_RES_ID: return "IMAGE_MP_ZOMBIE_TROPHY_HI_RES";
		case IMAGE_MP_TROPHY_BASE_ID: return "IMAGE_MP_TROPHY_BASE";
		case IMAGE_MP_TROPHY_BASE_HI_RES_ID: return "IMAGE_MP_TROPHY_BASE_HI_RES";
		case IMAGE_MP_PLANT_SIDE_ID: return "IMAGE_MP_PLANT_SIDE";
		case IMAGE_MP_PLANT_SIDE_SELECTED_ID: return "IMAGE_MP_PLANT_SIDE_SELECTED";
		case IMAGE_MP_PLANT_SIDE_PLANTS_ID: return "IMAGE_MP_PLANT_SIDE_PLANTS";
		case IMAGE_MP_ZOMBIE_SIDE_ID: return "IMAGE_MP_ZOMBIE_SIDE";
		case IMAGE_MP_ZOMBIE_SIDE_SELECTED_ID: return "IMAGE_MP_ZOMBIE_SIDE_SELECTED";
		case IMAGE_MP_ZOMBIE_SIDE_ZOMBIES_ID: return "IMAGE_MP_ZOMBIE_SIDE_ZOMBIES";
		case IMAGE_VS_INFO_BOX_PLANTS_ID: return "IMAGE_VS_INFO_BOX_PLANTS";
		case IMAGE_VS_INFO_BOX_PLANTS_OVERLAY_ID: return "IMAGE_VS_INFO_BOX_PLANTS_OVERLAY";
		case IMAGE_VS_INFO_BOX_ZOMBIES_ID: return "IMAGE_VS_INFO_BOX_ZOMBIES";
		case IMAGE_VS_INFO_BOX_ZOMBIES_OVERLAY_ID: return "IMAGE_VS_INFO_BOX_ZOMBIES_OVERLAY";
		case IMAGE_BUTTER_ICON_ID: return "IMAGE_BUTTER_ICON";
		case IMAGE_HAMMER_ICON_ID: return "IMAGE_HAMMER_ICON";
		case IMAGE_VS_STONE_DIRT_ID: return "IMAGE_VS_STONE_DIRT";
		...
		case IMAGE_STORE_ZENGARDENICON_ID: return "IMAGE_STORE_ZENGARDENICON";
		case IMAGE_SHOVELMETER_EMTY_ID: return "IMAGE_SHOVELMETER_EMTY";
		case IMAGE_SHOVELMETER_FULL_ID: return "IMAGE_SHOVELMETER_FULL";
		...
		case IMAGE_SEEDBANK_COOP_ID: return "IMAGE_SEEDBANK_COOP";
		...
		case IMAGE_CONVEYORBELT_BACKDROP_COOP_ID: return "IMAGE_CONVEYORBELT_BACKDROP_COOP";
		case IMAGE_CONVEYORBELT_COOP_ID: return "IMAGE_CONVEYORBELT_COOP";
		...
		case IMAGE_REANIM_POINT_ID: return "IMAGE_REANIM_POINT";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD1_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD1";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD2_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD2";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD4_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD4";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD5_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD5";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD6_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD6";
		case IMAGE_REANIM_SELECTORSCREEN_CLOUD7_ID: return "IMAGE_REANIM_SELECTORSCREEN_CLOUD7";
		case IMAGE_HOUSE_SKY_ID: return "IMAGE_HOUSE_SKY";
		case IMAGE_HOUSE_HILL_ID: return "IMAGE_HOUSE_HILL";
		case IMAGE_HOUSE_SIDEWALK_ID: return "IMAGE_HOUSE_SIDEWALK";
		case IMAGE_TRASHCAN_ZOMBIES_ID: return "IMAGE_TRASHCAN_ZOMBIES";
		case IMAGE_TRASHCAN_PLANTS_ID: return "IMAGE_TRASHCAN_PLANTS";
		case IMAGE_ZOMBIE_LAYER_TEST_ID: return "IMAGE_ZOMBIE_LAYER_TEST";
		case IMAGE_ZOMBIE_LAYER_1_1_ID: return "IMAGE_ZOMBIE_LAYER_1_1";
		case IMAGE_ZOMBIE_LAYER_1_2_ID: return "IMAGE_ZOMBIE_LAYER_1_2";
		case IMAGE_ZOMBIE_LAYER_1_3_ID: return "IMAGE_ZOMBIE_LAYER_1_3";
		case IMAGE_ZOMBIE_LAYER_2_1_ID: return "IMAGE_ZOMBIE_LAYER_2_1";
		case IMAGE_ZOMBIE_LAYER_2_2_ID: return "IMAGE_ZOMBIE_LAYER_2_2";
		case IMAGE_ZOMBIE_LAYER_2_3_ID: return "IMAGE_ZOMBIE_LAYER_2_3";
		case IMAGE_ZOMBIE_LAYER_3_1_ID: return "IMAGE_ZOMBIE_LAYER_3_1";
		case IMAGE_ZOMBIE_LAYER_3_2_ID: return "IMAGE_ZOMBIE_LAYER_3_2";
		case IMAGE_ZOMBIE_LAYER_3_3_ID: return "IMAGE_ZOMBIE_LAYER_3_3";
		case IMAGE_PLANT_LAYER_1_1_ID: return "IMAGE_PLANT_LAYER_1_1";
		case IMAGE_PLANT_LAYER_1_2_ID: return "IMAGE_PLANT_LAYER_1_2";
		case IMAGE_PLANT_LAYER_2_1_ID: return "IMAGE_PLANT_LAYER_2_1";
		case IMAGE_PLANT_LAYER_2_2_ID: return "IMAGE_PLANT_LAYER_2_2";
		case IMAGE_PLANT_LAYER_3_1_ID: return "IMAGE_PLANT_LAYER_3_1";
		case IMAGE_PLANT_LAYER_3_2_ID: return "IMAGE_PLANT_LAYER_3_2";
		...
		case IMAGE_ZOMBIE_HEAD_ID: return "IMAGE_ZOMBIE_HEAD";
		case IMAGE_LEADERBOARD_HOLE_ID: return "IMAGE_LEADERBOARD_HOLE";
		case IMAGE_LEADERBOARD_HOLE_PIPE_ID: return "IMAGE_LEADERBOARD_HOLE_PIPE";
		case IMAGE_LEADERBOARD_HOLE_WORM_ID: return "IMAGE_LEADERBOARD_HOLE_WORM";
		case IMAGE_LEADERBOARD_HOLE_GEMS_ID: return "IMAGE_LEADERBOARD_HOLE_GEMS";
		case IMAGE_LEADERBOARD_HOLE_CHINA_ID: return "IMAGE_LEADERBOARD_HOLE_CHINA";
		case IMAGE_LEADERBOARD_HOLE_ROCKS_ID: return "IMAGE_LEADERBOARD_HOLE_ROCKS";
		case IMAGE_LEADERBOARD_HOLE_TIKI_ID: return "IMAGE_LEADERBOARD_HOLE_TIKI";
		case IMAGE_LEADERBOARD_HOLE_BJORN_ID: return "IMAGE_LEADERBOARD_HOLE_BJORN";
		case IMAGE_LEADERBOARD_HEADER_SMALL_ID: return "IMAGE_LEADERBOARD_HEADER_SMALL";
		case IMAGE_LEADERBOARD_HEADER_LARGE_ID: return "IMAGE_LEADERBOARD_HEADER_LARGE";
		case IMAGE_LEADERBOARD_SELECTOR_ID: return "IMAGE_LEADERBOARD_SELECTOR";
		case IMAGE_LEADERBOARD_FILL_ID: return "IMAGE_LEADERBOARD_FILL";
		...
		case SOUND_MP_TIMER_ID: return "SOUND_MP_TIMER";
		case SOUND_CROW_FLAP1_ID: return "SOUND_CROW_FLAP1";
		case SOUND_CROW_FLAP2_ID: return "SOUND_CROW_FLAP2";
		case SOUND_CROW_FLAP3_ID: return "SOUND_CROW_FLAP3";
		case SOUND_CROW_CAW1_ID: return "SOUND_CROW_CAW1";
		case SOUND_CROW_CAW2_ID: return "SOUND_CROW_CAW2";
		case SOUND_CROW_CAW3_ID: return "SOUND_CROW_CAW3";
		case SOUND_THUNDER_1_ID: return "SOUND_THUNDER_1";
		case SOUND_THUNDER_2_ID: return "SOUND_THUNDER_2";
		case SOUND_THUNDER_3_ID: return "SOUND_THUNDER_3";
		case SOUND_THUNDER_1R_ID: return "SOUND_THUNDER_1R";
		case SOUND_THUNDER_2R_ID: return "SOUND_THUNDER_2R";
		case SOUND_THUNDER_3R_ID: return "SOUND_THUNDER_3R";
		case SOUND_MINIGAMES_ID: return "SOUND_MINIGAMES";
		case SOUND_PUZZLE_ID: return "SOUND_PUZZLE";
		case SOUND_SURVIVAL_ID: return "SOUND_SURVIVAL";
		case SOUND_COOP_ID: return "SOUND_COOP";
		case SOUND_VS_ID: return "SOUND_VS";
		case SOUND_MENU_L_ST_ID: return "SOUND_MENU_L_ST";
		case SOUND_MENU_C_ST_ID: return "SOUND_MENU_C_ST";
		case SOUND_MENU_R_ST_ID: return "SOUND_MENU_R_ST";
		case SOUND_SHOP_ID: return "SOUND_SHOP";
		case SOUND_ZEN_ID: return "SOUND_ZEN";
		case SOUND_MAIL_ID: return "SOUND_MAIL";
		case SOUND_ALMANAC_ID: return "SOUND_ALMANAC";
		case SOUND_VS_HEADPOP_ID: return "SOUND_VS_HEADPOP";
		case SOUND_BIGTHUD_ID: return "SOUND_BIGTHUD";
		...
		case IMAGE_ROOF_POLE_ID: return "IMAGE_ROOF_POLE";
		case IMAGE_ROOF_TREE_ID: return "IMAGE_ROOF_TREE";
		...
		case IMAGE_STORE_CAR_LICENSE0_ID: return "IMAGE_STORE_CAR_LICENSE0";
		case IMAGE_STORE_CAR_LICENSE1_ID: return "IMAGE_STORE_CAR_LICENSE1";
		case IMAGE_STORE_CAR_LICENSE2_ID: return "IMAGE_STORE_CAR_LICENSE2";
		case IMAGE_STORE_CAR_LICENSE3_ID: return "IMAGE_STORE_CAR_LICENSE3";
		case IMAGE_STORE_CAR_LICENSE4_ID: return "IMAGE_STORE_CAR_LICENSE4";
		case IMAGE_STORE_CAR_LICENSE5_ID: return "IMAGE_STORE_CAR_LICENSE5";
		case IMAGE_STORE_CAR_LICENSE6_ID: return "IMAGE_STORE_CAR_LICENSE6";
		case IMAGE_STORE_CAR_LICENSE7_ID: return "IMAGE_STORE_CAR_LICENSE7";
		case IMAGE_STORE_CAR_LICENSE8_ID: return "IMAGE_STORE_CAR_LICENSE8";
		case IMAGE_STORE_CAR_LICENSE9_ID: return "IMAGE_STORE_CAR_LICENSE9";
		case IMAGE_STORE_CAR_LICENSE10_ID: return "IMAGE_STORE_CAR_LICENSE10";
		case IMAGE_STORE_CAR_LICENSE11_ID: return "IMAGE_STORE_CAR_LICENSE11";
		...
		case IMAGE_STORESEEDPACK_CATTAIL_ID: return "IMAGE_STORESEEDPACK_CATTAIL";
		case IMAGE_STORESEEDPACK_COBCANNON_ID: return "IMAGE_STORESEEDPACK_COBCANNON";
		case IMAGE_STORESEEDPACK_DOUBLESUNFLOWER_ID: return "IMAGE_STORESEEDPACK_DOUBLESUNFLOWER";
		case IMAGE_STORESEEDPACK_FROZENWATERMELON_ID: return "IMAGE_STORESEEDPACK_FROZENWATERMELON";
		case IMAGE_STORESEEDPACK_GLOOMSHROOM_ID: return "IMAGE_STORESEEDPACK_GLOOMSHROOM";
		case IMAGE_STORESEEDPACK_GOLDMAGNET_ID: return "IMAGE_STORESEEDPACK_GOLDMAGNET";
		case IMAGE_STORESEEDPACK_IMITATER_ID: return "IMAGE_STORESEEDPACK_IMITATER";
		case IMAGE_STORESEEDPACK_REPEATER_ID: return "IMAGE_STORESEEDPACK_REPEATER";
		case IMAGE_STORESEEDPACK_SPIKEROCK_ID: return "IMAGE_STORESEEDPACK_SPIKEROCK";
