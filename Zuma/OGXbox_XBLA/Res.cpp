...
Image* Sexy::IMAGE_ADVLEADERBOARD;
...
bool Sexy::ExtractAdventureScreenResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ADVLEADERBOARD = aMgr.GetImageThrow("IMAGE_ADVLEADERBOARD");
...
Image* Sexy::IMAGE_GAUNTGLOWARROW;
Image* Sexy::IMAGE_GAUNTGLOWARROW2;
Image* Sexy::IMAGE_GAUNTGLOWCHOOSELEVEL;
Image* Sexy::IMAGE_GAUNTGLOWCHOOSEMODE;
Image* Sexy::IMAGE_GAUNTGLOWMAINMENU;
Image* Sexy::IMAGE_GAUNTGLOWPRESS2START;
Image* Sexy::IMAGE_GAUNTGLOWPRESS2STARTBG;
Image* Sexy::IMAGE_GAUNTGLOWSKILLLEVEL;
...
Image* Sexy::IMAGE_GAUNTSKILLLEVEL;
Image* Sexy::IMAGE_GAUNTSKILLLEVELOFF;
...
bool Sexy::ExtractGauntletScreenResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_GAUNTGLOWARROW = aMgr.GetImageThrow("IMAGE_GAUNTGLOWARROW");
		IMAGE_GAUNTGLOWARROW2 = aMgr.GetImageThrow("IMAGE_GAUNTGLOWARROW2");
		IMAGE_GAUNTGLOWCHOOSELEVEL = aMgr.GetImageThrow("IMAGE_GAUNTGLOWCHOOSELEVEL");
		IMAGE_GAUNTGLOWCHOOSEMODE = aMgr.GetImageThrow("IMAGE_GAUNTGLOWCHOOSEMODE");
		IMAGE_GAUNTGLOWMAINMENU = aMgr.GetImageThrow("IMAGE_GAUNTGLOWMAINMENU");
		IMAGE_GAUNTGLOWPRESS2START = aMgr.GetImageThrow("IMAGE_GAUNTGLOWPRESS2START");
		IMAGE_GAUNTGLOWPRESS2STARTBG = aMgr.GetImageThrow("IMAGE_GAUNTGLOWPRESS2STARTBG");
		IMAGE_GAUNTGLOWSKILLLEVEL = aMgr.GetImageThrow("IMAGE_GAUNTGLOWSKILLLEVEL");
		...
		IMAGE_GAUNTSKILLLEVEL = aMgr.GetImageThrow("IMAGE_GAUNTSKILLLEVEL");
		IMAGE_GAUNTSKILLLEVELOFF = aMgr.GetImageThrow("IMAGE_GAUNTSKILLLEVELOFF");
...
Image* Sexy::IMAGE_HELP_CONTROLLER;
Image* Sexy::IMAGE_HELP_FRONT;
Image* Sexy::IMAGE_HELP_FRONT2;
...
bool Sexy::ExtractHelpScreenResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_HELP_CONTROLLER = aMgr.GetImageThrow("IMAGE_HELP_CONTROLLER");
		IMAGE_HELP_FRONT = aMgr.GetImageThrow("IMAGE_HELP_FRONT");
		IMAGE_HELP_FRONT2 = aMgr.GetImageThrow("IMAGE_HELP_FRONT2");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_ADVSTAR;
Image* Sexy::IMAGE_BUTTONA;
Image* Sexy::IMAGE_BUTTONB;
Image* Sexy::IMAGE_BUTTONL;
Image* Sexy::IMAGE_BUTTONRL;
Image* Sexy::IMAGE_BUTTONUD;
Image* Sexy::IMAGE_BUTTONX;
Image* Sexy::IMAGE_BUTTONY;
...
bool Sexy::ExtractInitResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ADVSTAR = aMgr.GetImageThrow("IMAGE_ADVSTAR");
		IMAGE_BUTTONA = aMgr.GetImageThrow("IMAGE_BUTTONA");
		IMAGE_BUTTONB = aMgr.GetImageThrow("IMAGE_BUTTONB");
		IMAGE_BUTTONL = aMgr.GetImageThrow("IMAGE_BUTTONL");
		IMAGE_BUTTONRL = aMgr.GetImageThrow("IMAGE_BUTTONRL");
		IMAGE_BUTTONUD = aMgr.GetImageThrow("IMAGE_BUTTONUD");
		IMAGE_BUTTONX = aMgr.GetImageThrow("IMAGE_BUTTONX");
		IMAGE_BUTTONY = aMgr.GetImageThrow("IMAGE_BUTTONY");
...
static void* gResources[] =
{
	...
	&IMAGE_GAUNTSUNGEM,
	&IMAGE_GAUNTTITLE,
	&IMAGE_GAUNTGLOWSKILLLEVEL,
	&IMAGE_GAUNTSKILLLEVEL,
	&IMAGE_GAUNTSKILLLEVELOFF,
	&IMAGE_GAUNTGLOWMAINMENU,
	&IMAGE_GAUNTGLOWPRESS2START,
	&IMAGE_GAUNTGLOWPRESS2STARTBG,
	&IMAGE_GAUNTGLOWARROW,
	&IMAGE_GAUNTGLOWARROW2,
	&IMAGE_GAUNTGLOWCHOOSELEVEL,
	&IMAGE_GAUNTGLOWCHOOSEMODE,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_BUTTONA_ID: return "IMAGE_BUTTONA";
		case IMAGE_BUTTONB_ID: return "IMAGE_BUTTONB";
		case IMAGE_BUTTONX_ID: return "IMAGE_BUTTONX";
		case IMAGE_BUTTONY_ID: return "IMAGE_BUTTONY";
		case IMAGE_BUTTONL_ID: return "IMAGE_BUTTONL";
		case IMAGE_BUTTONRL_ID: return "IMAGE_BUTTONRL";
		case IMAGE_BUTTONUD_ID: return "IMAGE_BUTTONUD";
		case IMAGE_ADVSTAR_ID: return "IMAGE_ADVSTAR";
		...
		case IMAGE_HELP_CONTROLLER_ID: return "IMAGE_HELP_CONTROLLER";
		case IMAGE_HELP_FRONT2_ID: return "IMAGE_HELP_FRONT2";
		...
		case IMAGE_ADVLEADERBOARD_ID: return "IMAGE_ADVLEADERBOARD";
		...
		case IMAGE_GAUNTGLOWSKILLLEVEL_ID: return "IMAGE_GAUNTGLOWSKILLLEVEL";
		case IMAGE_GAUNTSKILLLEVEL_ID: return "IMAGE_GAUNTSKILLLEVEL";
		case IMAGE_GAUNTSKILLLEVELOFF_ID: return "IMAGE_GAUNTSKILLLEVELOFF";
		case IMAGE_GAUNTGLOWMAINMENU_ID: return "IMAGE_GAUNTGLOWMAINMENU";
		case IMAGE_GAUNTGLOWPRESS2START_ID: return "IMAGE_GAUNTGLOWPRESS2START";
		case IMAGE_GAUNTGLOWPRESS2STARTBG_ID: return "IMAGE_GAUNTGLOWPRESS2STARTBG";
		case IMAGE_GAUNTGLOWARROW_ID: return "IMAGE_GAUNTGLOWARROW";
		case IMAGE_GAUNTGLOWARROW2_ID: return "IMAGE_GAUNTGLOWARROW2";
		case IMAGE_GAUNTGLOWCHOOSELEVEL_ID: return "IMAGE_GAUNTGLOWCHOOSELEVEL";
		case IMAGE_GAUNTGLOWCHOOSEMODE_ID: return "IMAGE_GAUNTGLOWCHOOSEMODE";
