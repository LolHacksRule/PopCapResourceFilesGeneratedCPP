...
bool Sexy::ExtractResourcesByName(ResourceManager *theManager, const char *theName)
{
	...
	if (strcmp(theName,"EyeBlaster")==0) return ExtractEyeBlasterResources(theManager);
	if (strcmp(theName,"EyeBlasterExtended")==0) return ExtractEyeBlasterExtendedResources(theManager);
	...
	if (strcmp(theName,"LevelLocked")==0) return ExtractLevelLockedResources(theManager);
...
// EyeBlaster Resources
Font* Sexy::FONT_SMALL_ARIAL;
Image* Sexy::IMAGE_EYEBLASTER_BACKGROUND;
Image* Sexy::IMAGE_EYEBLASTER_BUYBUTTON;

bool Sexy::ExtractEyeBlasterResources(ResourceManager *theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		FONT_SMALL_ARIAL = aMgr.GetFontThrow("FONT_SMALL_ARIAL");
		IMAGE_EYEBLASTER_BACKGROUND = aMgr.GetImageThrow("IMAGE_EYEBLASTER_BACKGROUND");
		IMAGE_EYEBLASTER_BUYBUTTON = aMgr.GetImageThrow("IMAGE_EYEBLASTER_BUYBUTTON");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
// EyeBlasterExtended Resources
Image* Sexy::IMAGE_EYEBLASTER_MAXBUTTON;
Image* Sexy::IMAGE_EYEBLASTER_RESTOREBUTTON;
Image* Sexy::IMAGE_EYEBLASTER_SKIPBUTTON;

bool Sexy::ExtractEyeBlasterExtendedResources(ResourceManager *theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_EYEBLASTER_MAXBUTTON = aMgr.GetImageThrow("IMAGE_EYEBLASTER_MAXBUTTON");
		IMAGE_EYEBLASTER_RESTOREBUTTON = aMgr.GetImageThrow("IMAGE_EYEBLASTER_RESTOREBUTTON");
		IMAGE_EYEBLASTER_SKIPBUTTON = aMgr.GetImageThrow("IMAGE_EYEBLASTER_SKIPBUTTON");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
// LevelLocked Resources
Font* Sexy::FONT_UPSELL;
Image* Sexy::IMAGE_LEVLOCK_BACKGROUND;
Image* Sexy::IMAGE_LEVLOCK_BUTTONS;
Image* Sexy::IMAGE_LEVLOCK_BUYBUTTON;
Image* Sexy::IMAGE_LEVLOCK_BUYLABEL;
Image* Sexy::IMAGE_LEVLOCK_PLAYBUTTON;
Image* Sexy::IMAGE_LEVLOCK_PLAYLABEL;

bool Sexy::ExtractLevelLockedResources(ResourceManager *theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		FONT_UPSELL = aMgr.GetFontThrow("FONT_UPSELL");
		IMAGE_LEVLOCK_BACKGROUND = aMgr.GetImageThrow("IMAGE_LEVLOCK_BACKGROUND");
		IMAGE_LEVLOCK_BUTTONS = aMgr.GetImageThrow("IMAGE_LEVLOCK_BUTTONS");
		IMAGE_LEVLOCK_BUYBUTTON = aMgr.GetImageThrow("IMAGE_LEVLOCK_BUYBUTTON");
		IMAGE_LEVLOCK_BUYLABEL = aMgr.GetImageThrow("IMAGE_LEVLOCK_BUYLABEL");
		IMAGE_LEVLOCK_PLAYBUTTON = aMgr.GetImageThrow("IMAGE_LEVLOCK_PLAYBUTTON");
		IMAGE_LEVLOCK_PLAYLABEL = aMgr.GetImageThrow("IMAGE_LEVLOCK_PLAYLABEL");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
bool Sexy::ExtractLoadingThreadResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		FONT_BROWNTITLE_EN = aMgr.GetFontThrow("FONT_BROWNTITLE_EN");
...
static void* gResources[] =
{
	...
	&FONT_PLAIN,
	&SOUND_BUTTON1,
	&IMAGE_EYEBLASTER_BACKGROUND,
	&IMAGE_EYEBLASTER_BUYBUTTON,
	&FONT_SMALL_ARIAL,
	&IMAGE_EYEBLASTER_MAXBUTTON,
	&IMAGE_EYEBLASTER_RESTOREBUTTON,
	&IMAGE_EYEBLASTER_SKIPBUTTON,
	&IMAGE_LEVLOCK_BACKGROUND,
	&IMAGE_LEVLOCK_BUYLABEL,
	&IMAGE_LEVLOCK_PLAYLABEL,
	&IMAGE_LEVLOCK_BUTTONS,
	&IMAGE_LEVLOCK_PLAYBUTTON,
	&IMAGE_LEVLOCK_BUYBUTTON,
	&FONT_UPSELL,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_EYEBLASTER_BACKGROUND_ID: return "IMAGE_EYEBLASTER_BACKGROUND";
		case IMAGE_EYEBLASTER_BUYBUTTON_ID: return "IMAGE_EYEBLASTER_BUYBUTTON";
		case FONT_SMALL_ARIAL_ID: return "FONT_SMALL_ARIAL";
		case IMAGE_EYEBLASTER_MAXBUTTON_ID: return "IMAGE_EYEBLASTER_MAXBUTTON";
		case IMAGE_EYEBLASTER_RESTOREBUTTON_ID: return "IMAGE_EYEBLASTER_RESTOREBUTTON";
		case IMAGE_EYEBLASTER_SKIPBUTTON_ID: return "IMAGE_EYEBLASTER_SKIPBUTTON";
		case IMAGE_LEVLOCK_BACKGROUND_ID: return "IMAGE_LEVLOCK_BACKGROUND";
		case IMAGE_LEVLOCK_BUYLABEL_ID: return "IMAGE_LEVLOCK_BUYLABEL";
		case IMAGE_LEVLOCK_PLAYLABEL_ID: return "IMAGE_LEVLOCK_PLAYLABEL";
		case IMAGE_LEVLOCK_BUTTONS_ID: return "IMAGE_LEVLOCK_BUTTONS";
		case IMAGE_LEVLOCK_PLAYBUTTON_ID: return "IMAGE_LEVLOCK_PLAYBUTTON";
		case IMAGE_LEVLOCK_BUYBUTTON_ID: return "IMAGE_LEVLOCK_BUYBUTTON";
		case FONT_UPSELL_ID: return "FONT_UPSELL";
		...
		case FONT_BROWNTITLE_EN_ID: return "FONT_BROWNTITLE_EN";
