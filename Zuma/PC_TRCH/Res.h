...
namespace Sexy
{
	...
	bool ExtractEyeBlasterResources(ResourceManager *theMgr);
	extern Font* FONT_SMALL_ARIAL;
	extern Image* IMAGE_EYEBLASTER_BACKGROUND;
	extern Image* IMAGE_EYEBLASTER_BUYBUTTON;

	// EyeBlasterExtended Resources
	bool ExtractEyeBlasterExtendedResources(ResourceManager *theMgr);
	extern Image* IMAGE_EYEBLASTER_MAXBUTTON;
	extern Image* IMAGE_EYEBLASTER_RESTOREBUTTON;
	extern Image* IMAGE_EYEBLASTER_SKIPBUTTON;
	...
	bool ExtractLevelLockedResources(ResourceManager *theMgr);
	extern Font* FONT_UPSELL;
	extern Image* IMAGE_LEVLOCK_BACKGROUND;
	extern Image* IMAGE_LEVLOCK_BUTTONS;
	extern Image* IMAGE_LEVLOCK_BUYBUTTON;
	extern Image* IMAGE_LEVLOCK_BUYLABEL;
	extern Image* IMAGE_LEVLOCK_PLAYBUTTON;
	extern Image* IMAGE_LEVLOCK_PLAYLABEL;

	// LoadingThread Resources
	bool ExtractLoadingThreadResources(ResourceManager *theMgr);
	extern Font* FONT_BROWNTITLE;
	extern Font* FONT_BROWNTITLE_EN;
	...
	enum ResourceId
	{
		...
		FONT_PLAIN_ID,
		SOUND_BUTTON1_ID,
		IMAGE_EYEBLASTER_BACKGROUND_ID,
		IMAGE_EYEBLASTER_BUYBUTTON_ID,
		FONT_SMALL_ARIAL_ID,
		IMAGE_EYEBLASTER_MAXBUTTON_ID,
		IMAGE_EYEBLASTER_RESTOREBUTTON_ID,
		IMAGE_EYEBLASTER_SKIPBUTTON_ID,
		IMAGE_LEVLOCK_BACKGROUND_ID,
		IMAGE_LEVLOCK_BUYLABEL_ID,
		IMAGE_LEVLOCK_PLAYLABEL_ID,
		IMAGE_LEVLOCK_BUTTONS_ID,
		IMAGE_LEVLOCK_PLAYBUTTON_ID,
		IMAGE_LEVLOCK_BUYBUTTON_ID,
		FONT_UPSELL_ID,
